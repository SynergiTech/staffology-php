...
class EmployeeApi
{
    ...
    /**
     * Operation resetEmployeeHolidayAccrualSchemeEmployee
     *
     * Resets employee accrual scheme
     *
     * @param  string $employerId The Id of the Employer (required)
     * @param  string[]|null $requestBody UnqiueId of the employees for setting the Holiday Scheme Reset Date (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['resetEmployeeHolidayAccrualSchemeEmployee'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
     */
    public function resetEmployeeHolidayAccrualSchemeEmployee(
        string $employerId,
        ?array $requestBody = null,
        string $contentType = self::contentTypes['resetEmployeeHolidayAccrualSchemeEmployee'][0]
    ): void
    {
        $this->resetEmployeeHolidayAccrualSchemeEmployeeWithHttpInfo($employerId, $requestBody, $contentType);
    }

    /**
     * Operation resetEmployeeHolidayAccrualSchemeEmployeeWithHttpInfo
     *
     * Resets employee accrual scheme
     *
     * @param  string $employerId The Id of the Employer (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function resetEmployeeHolidayAccrualSchemeEmployeeWithHttpInfo(
        string $employerId,
        ?array $requestBody = null,
        string $contentType = self::contentTypes['resetEmployeeHolidayAccrualSchemeEmployee'][0]
    ): array
    {
        $request = $this->resetEmployeeHolidayAccrualSchemeEmployeeRequest($employerId, $requestBody, $contentType);
    ...
    /**
     * Operation resetEmployeeHolidayAccrualSchemeEmployeeAsync
     *
     * Resets employee accrual scheme
     *
     * @param  string $employerId The Id of the Employer (required)
     ...
     * @return PromiseInterface
     */
    public function resetEmployeeHolidayAccrualSchemeEmployeeAsync(
        string $employerId,
        ?array $requestBody = null,
        string $contentType = self::contentTypes['resetEmployeeHolidayAccrualSchemeEmployee'][0]
    ): PromiseInterface
    {
        return $this->resetEmployeeHolidayAccrualSchemeEmployeeAsyncWithHttpInfo($employerId, $requestBody, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation resetEmployeeHolidayAccrualSchemeEmployeeAsyncWithHttpInfo
     *
     * Resets employee accrual scheme
     *
     * @param  string $employerId The Id of the Employer (required)
     ...
     * @return PromiseInterface
     */
    public function resetEmployeeHolidayAccrualSchemeEmployeeAsyncWithHttpInfo(
        string $employerId,
        ?array $requestBody = null,
        string $contentType = self::contentTypes['resetEmployeeHolidayAccrualSchemeEmployee'][0]
    ): PromiseInterface
    ...
    /**
     * Create request for operation 'resetEmployeeHolidayAccrualSchemeEmployee'
     *
     * @param  string $employerId The Id of the Employer (required)
     * @param  string[]|null $requestBody UnqiueId of the employees for setting the Holiday Scheme Reset Date (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['resetEmployeeHolidayAccrualSchemeEmployee'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function resetEmployeeHolidayAccrualSchemeEmployeeRequest(
        string $employerId,
        ?array $requestBody = null,
        string $contentType = self::contentTypes['resetEmployeeHolidayAccrualSchemeEmployee'][0]
    ): Request
    {
        ...
        if ($employerId === null || (is_array($employerId) && count($employerId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $employerId when calling resetEmployeeHolidayAccrualSchemeEmployee'
            );
        }



        $resourcePath = '/employers/{employerId}/employees/reset-holiday-scheme';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
