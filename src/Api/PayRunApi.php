...
class PayRunApi
{
     ...
     * @param  bool|null $rolledBackOnly If set to true, returns rolled back pay run entries. If false, returns all entries. (optional, default to false)
    ...
    public function getPayRunPayRun(
        ...
        ?bool $rolledBackOnly = false,
        string $contentType = self::contentTypes['getPayRunPayRun'][0]
    ): \SynergiTech\Staffology\Model\PayRun
    {
        list($response) = $this->getPayRunPayRunWithHttpInfo($employerId, $payPeriod, $periodNumber, $taxYear, $ordinal, $pageNum, $pageSize, $searchTerm, $zeroPaid, $departmentCode, $startersLeavers, $sortBy, $sortDescending, $rolledBackOnly, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getPayRunPayRunRequest($employerId, $payPeriod, $periodNumber, $taxYear, $ordinal, $pageNum, $pageSize, $searchTerm, $zeroPaid, $departmentCode, $startersLeavers, $sortBy, $sortDescending, $rolledBackOnly, $contentType);
    ...
    {
        return $this->getPayRunPayRunAsyncWithHttpInfo($employerId, $payPeriod, $periodNumber, $taxYear, $ordinal, $pageNum, $pageSize, $searchTerm, $zeroPaid, $departmentCode, $startersLeavers, $sortBy, $sortDescending, $rolledBackOnly, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $rolledBackOnly,
            'rolledBackOnly', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
