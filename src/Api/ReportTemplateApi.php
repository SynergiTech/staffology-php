...
class ReportTemplateApi
{
     ...
     * @param  \SynergiTech\Staffology\Model\ContractReportTemplateRequest|null $contractReportTemplateRequest contractReportTemplateRequest (optional)
     ...
     * @return \SynergiTech\Staffology\Model\ContractReportTemplateResponse
     */
    public function createReportTemplate(
        string $employerId,
        ?\SynergiTech\Staffology\Model\ContractReportTemplateRequest $contractReportTemplateRequest = null,
        string $contentType = self::contentTypes['createReportTemplate'][0]
    ): \SynergiTech\Staffology\Model\ContractReportTemplateResponse
    {
        list($response) = $this->createReportTemplateWithHttpInfo($employerId, $contractReportTemplateRequest, $contentType);
        return $response;
    }
     ...
     *
     * @param  string $employerId The Id of the Employer to which the Report Template belongs. (required)
     * @param  \SynergiTech\Staffology\Model\ContractReportTemplateRequest|null $contractReportTemplateRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createReportTemplate'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of |\SynergiTech\Staffology\Model\ContractReportTemplateResponse, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $request = $this->createReportTemplateRequest($employerId, $contractReportTemplateRequest, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 201:
                    if (in_array('\SynergiTech\Staffology\Model\ContractReportTemplateResponse', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SynergiTech\Staffology\Model\ContractReportTemplateResponse' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SynergiTech\Staffology\Model\ContractReportTemplateResponse', []),
            ...
            $returnType = '\SynergiTech\Staffology\Model\ContractReportTemplateResponse';
    ...
    {
        return $this->createReportTemplateAsyncWithHttpInfo($employerId, $contractReportTemplateRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    ): Request
    {
        ...
        $resourcePath = '/employers/{employerId}/reporttemplate';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($contractReportTemplateRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($contractReportTemplateRequest));
            } else {
                $httpBody = $contractReportTemplateRequest;
            }
    ...
    ): Request
    {
        ...
        $resourcePath = '/employers/{employerId}/reporttemplate/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getContentDictionaryReportTemplate
     *
     * Get Content Dictionary For Report Template Column Type(beta)
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getContentDictionaryReportTemplate'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SynergiTech\Staffology\Model\ContractReportTemplateContentDictionaryResponse[]
     */
    public function getContentDictionaryReportTemplate(
        string $contentType = self::contentTypes['getContentDictionaryReportTemplate'][0]
    ): array
    {
        list($response) = $this->getContentDictionaryReportTemplateWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getContentDictionaryReportTemplateWithHttpInfo
     *
     * Get Content Dictionary For Report Template Column Type(beta)
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getContentDictionaryReportTemplate'] to see the possible values for this operation
     ...
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of \SynergiTech\Staffology\Model\ContractReportTemplateContentDictionaryResponse[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getContentDictionaryReportTemplateWithHttpInfo(
        string $contentType = self::contentTypes['getContentDictionaryReportTemplate'][0]
    ): array
    {
        $request = $this->getContentDictionaryReportTemplateRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if (in_array('\SynergiTech\Staffology\Model\ContractReportTemplateContentDictionaryResponse[]', ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\SynergiTech\Staffology\Model\ContractReportTemplateContentDictionaryResponse[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\SynergiTech\Staffology\Model\ContractReportTemplateContentDictionaryResponse[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\SynergiTech\Staffology\Model\ContractReportTemplateContentDictionaryResponse[]';
            if (in_array($returnType, ['\SplFileObject', '\Psr\Http\Message\StreamInterface'])) {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation getContentDictionaryReportTemplateAsync
     *
     * Get Content Dictionary For Report Template Column Type(beta)
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getContentDictionaryReportTemplate'] to see the possible values for this operation
     ...
     * @return PromiseInterface
     */
    public function getContentDictionaryReportTemplateAsync(
        string $contentType = self::contentTypes['getContentDictionaryReportTemplate'][0]
    ): PromiseInterface
    {
        return $this->getContentDictionaryReportTemplateAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getContentDictionaryReportTemplateAsyncWithHttpInfo
     *
     * Get Content Dictionary For Report Template Column Type(beta)
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getContentDictionaryReportTemplate'] to see the possible values for this operation
     ...
     * @return PromiseInterface
     */
    public function getContentDictionaryReportTemplateAsyncWithHttpInfo(
        string $contentType = self::contentTypes['getContentDictionaryReportTemplate'][0]
    ): PromiseInterface
    {
        $returnType = '\SynergiTech\Staffology\Model\ContractReportTemplateContentDictionaryResponse[]';
    ...
    /**
     * Create request for operation 'getContentDictionaryReportTemplate'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getContentDictionaryReportTemplate'] to see the possible values for this operation
     *
     * @throws InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContentDictionaryReportTemplateRequest(
        string $contentType = self::contentTypes['getContentDictionaryReportTemplate'][0]
    ): Request
    {


        $resourcePath = '/contentdictionary';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->updateReportTemplateWithHttpInfo($employerId, $id, $contractReportTemplateRequest, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->updateReportTemplateRequest($employerId, $id, $contractReportTemplateRequest, $contentType);
    ...
    {
        return $this->updateReportTemplateAsyncWithHttpInfo($employerId, $id, $contractReportTemplateRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation validateReportTemplateColumnsReportTemplate
     *
     * Validate Report Template Columns(beta)
     *
     * @param  \SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest|null $contractReportTemplateColumnRequest contractReportTemplateColumnRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['validateReportTemplateColumnsReportTemplate'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
     */
    public function validateReportTemplateColumnsReportTemplate(
        ?\SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest $contractReportTemplateColumnRequest = null,
        string $contentType = self::contentTypes['validateReportTemplateColumnsReportTemplate'][0]
    ): void
    {
        $this->validateReportTemplateColumnsReportTemplateWithHttpInfo($contractReportTemplateColumnRequest, $contentType);
    }

    /**
     * Operation validateReportTemplateColumnsReportTemplateWithHttpInfo
     *
     * Validate Report Template Columns(beta)
     *
     * @param  \SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest|null $contractReportTemplateColumnRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['validateReportTemplateColumnsReportTemplate'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function validateReportTemplateColumnsReportTemplateWithHttpInfo(
        ?\SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest $contractReportTemplateColumnRequest = null,
        string $contentType = self::contentTypes['validateReportTemplateColumnsReportTemplate'][0]
    ): array
    {
        $request = $this->validateReportTemplateColumnsReportTemplateRequest($contractReportTemplateColumnRequest, $contentType);
    ...
    /**
     * Operation validateReportTemplateColumnsReportTemplateAsync
     *
     * Validate Report Template Columns(beta)
     *
     * @param  \SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest|null $contractReportTemplateColumnRequest (optional)
     ...
     * @return PromiseInterface
     */
    public function validateReportTemplateColumnsReportTemplateAsync(
        ?\SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest $contractReportTemplateColumnRequest = null,
        string $contentType = self::contentTypes['validateReportTemplateColumnsReportTemplate'][0]
    ): PromiseInterface
    {
        return $this->validateReportTemplateColumnsReportTemplateAsyncWithHttpInfo($contractReportTemplateColumnRequest, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation validateReportTemplateColumnsReportTemplateAsyncWithHttpInfo
     *
     * Validate Report Template Columns(beta)
     *
     * @param  \SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest|null $contractReportTemplateColumnRequest (optional)
     ...
     * @return PromiseInterface
     */
    public function validateReportTemplateColumnsReportTemplateAsyncWithHttpInfo(
        ?\SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest $contractReportTemplateColumnRequest = null,
        string $contentType = self::contentTypes['validateReportTemplateColumnsReportTemplate'][0]
    ): PromiseInterface
    {
    ...
    /**
     * Create request for operation 'validateReportTemplateColumnsReportTemplate'
     *
     * @param  \SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest|null $contractReportTemplateColumnRequest (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['validateReportTemplateColumnsReportTemplate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function validateReportTemplateColumnsReportTemplateRequest(
        ?\SynergiTech\Staffology\Model\ContractReportTemplateColumnRequest $contractReportTemplateColumnRequest = null,
        string $contentType = self::contentTypes['validateReportTemplateColumnsReportTemplate'][0]
    ): Request
    {
        ...
        // for model (json/xml)
        if (isset($contractReportTemplateColumnRequest)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($contractReportTemplateColumnRequest));
            } else {
                $httpBody = $contractReportTemplateColumnRequest;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
