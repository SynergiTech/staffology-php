...
class PaySpineApi
{
     ...
     * @param  string|null $workingPatternId The selected WorkingPattern Id. (optional)
     * @param  string|null $roleId The Role Id. (optional)
    ...
    {
        list($response) = $this->getAnnualValueFromSalaryFormulaPaySpineWithHttpInfo($employerId, $id, $employeeId, $paySpineGradeId, $spinalPointId, $londonAllowanceType, $effectiveFrom, $workingPatternId, $roleId, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getAnnualValueFromSalaryFormulaPaySpineRequest($employerId, $id, $employeeId, $paySpineGradeId, $spinalPointId, $londonAllowanceType, $effectiveFrom, $workingPatternId, $roleId, $contentType);
    ...
    {
        return $this->getAnnualValueFromSalaryFormulaPaySpineAsyncWithHttpInfo($employerId, $id, $employeeId, $paySpineGradeId, $spinalPointId, $londonAllowanceType, $effectiveFrom, $workingPatternId, $roleId, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSpinalPointWithAnnualSalaryPaySpine
     *
     ...
     * @param  string $id The selected PaySpine Id. (required)
     * @param  string $spinalPointId The selected SpinalPoint Id. (required)
     * @param  \DateTime $effectiveFrom The PayLine effective from. (required)
     * @param  string|null $paySpineGradeId The selected PaySpineGrade Id. (optional)
     * @param  int|null $londonAllowanceType The London Allowance Id of PayLine. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSpinalPointWithAnnualSalaryPaySpine'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return \SynergiTech\Staffology\Model\ContractSpinalPointResponse
     */
    public function getSpinalPointWithAnnualSalaryPaySpine(
        string $employerId,
        string $employeeId,
        string $id,
        string $spinalPointId,
        ...
        ?string $paySpineGradeId = null,
        ?int $londonAllowanceType = null,
        string $contentType = self::contentTypes['getSpinalPointWithAnnualSalaryPaySpine'][0]
    ): \SynergiTech\Staffology\Model\ContractSpinalPointResponse
    {
        list($response) = $this->getSpinalPointWithAnnualSalaryPaySpineWithHttpInfo($employerId, $employeeId, $id, $spinalPointId, $effectiveFrom, $paySpineGradeId, $londonAllowanceType, $contentType);
        return $response;
    }

    /**
     * Operation getSpinalPointWithAnnualSalaryPaySpineWithHttpInfo
     *
     * Get Spinal Point With Final Annual Salary
     *
     * @param  string $employerId The Employer id. (required)
     ...
     * @return array of \SynergiTech\Staffology\Model\ContractSpinalPointResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSpinalPointWithAnnualSalaryPaySpineWithHttpInfo(
        string $employerId,
        string $employeeId,
        string $id,
        string $spinalPointId,
    ...
    {
        $request = $this->getSpinalPointWithAnnualSalaryPaySpineRequest($employerId, $employeeId, $id, $spinalPointId, $effectiveFrom, $paySpineGradeId, $londonAllowanceType, $contentType);
    ...
    /**
     * Operation getSpinalPointWithAnnualSalaryPaySpineAsync
     *
     * Get Spinal Point With Final Annual Salary
     *
     * @param  string $employerId The Employer id. (required)
     ...
     * @return PromiseInterface
     */
    public function getSpinalPointWithAnnualSalaryPaySpineAsync(
        string $employerId,
        string $employeeId,
        string $id,
        string $spinalPointId,
    ...
    {
        return $this->getSpinalPointWithAnnualSalaryPaySpineAsyncWithHttpInfo($employerId, $employeeId, $id, $spinalPointId, $effectiveFrom, $paySpineGradeId, $londonAllowanceType, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSpinalPointWithAnnualSalaryPaySpineAsyncWithHttpInfo
     *
     * Get Spinal Point With Final Annual Salary
     *
     * @param  string $employerId The Employer id. (required)
     ...
     * @return PromiseInterface
     */
    public function getSpinalPointWithAnnualSalaryPaySpineAsyncWithHttpInfo(
        string $employerId,
        string $employeeId,
        string $id,
        string $spinalPointId,
    ...
    /**
     * Create request for operation 'getSpinalPointWithAnnualSalaryPaySpine'
     *
     * @param  string $employerId The Employer id. (required)
     * @param  string $employeeId The Employee id. (required)
     * @param  string $id The selected PaySpine Id. (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSpinalPointWithAnnualSalaryPaySpineRequest(
        string $employerId,
        string $employeeId,
        string $id,
        string $spinalPointId,
    ...
    ): Request
    {
        ...
        if ($employerId === null || (is_array($employerId) && count($employerId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $employerId when calling getSpinalPointWithAnnualSalaryPaySpine'
            );
        }
        ...
        if ($employeeId === null || (is_array($employeeId) && count($employeeId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $employeeId when calling getSpinalPointWithAnnualSalaryPaySpine'
            );
        }
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $id when calling getSpinalPointWithAnnualSalaryPaySpine'
            );
        }
        ...
        if ($spinalPointId === null || (is_array($spinalPointId) && count($spinalPointId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $spinalPointId when calling getSpinalPointWithAnnualSalaryPaySpine'
            );
        }

        // verify the required parameter 'effectiveFrom' is set
        if ($effectiveFrom === null || (is_array($effectiveFrom) && count($effectiveFrom) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $effectiveFrom when calling getSpinalPointWithAnnualSalaryPaySpine'
            );
        }
        ...
        $resourcePath = '/employers/{employerId}/payspines/{id}/employees/{employeeId}/getspinalpointwithannualsalary/{spinalPointId}/{effectiveFrom}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($effectiveFrom !== null) {
            $resourcePath = str_replace(
                '{' . 'effectiveFrom' . '}',
                ObjectSerializer::toPathValue($effectiveFrom),
                $resourcePath
            );
        }
