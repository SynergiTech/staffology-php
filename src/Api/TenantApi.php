...
class TenantApi
{
    ...
    /**
     * Operation setUserCanUseRefactoredAeRoutinesTenant
     *
     * Set CanUseRefactoredAeRoutines flag
     *
     * @param  string $id The Id of the Tenant. (required)
     * @param  string $userId The Id of the User. (required)
     * @param  bool|null $canUseRefactoredAeRoutines The CanUseRefactoredAeRoutines flag for the User. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setUserCanUseRefactoredAeRoutinesTenant'] to see the possible values for this operation
     *
     * @throws ApiException on non-2xx response or if the response body is not in the expected format
     * @throws InvalidArgumentException
     * @return void
     */
    public function setUserCanUseRefactoredAeRoutinesTenant(
        string $id,
        string $userId,
        ?bool $canUseRefactoredAeRoutines = null,
        string $contentType = self::contentTypes['setUserCanUseRefactoredAeRoutinesTenant'][0]
    ): void
    {
        $this->setUserCanUseRefactoredAeRoutinesTenantWithHttpInfo($id, $userId, $canUseRefactoredAeRoutines, $contentType);
    }

    /**
     * Operation setUserCanUseRefactoredAeRoutinesTenantWithHttpInfo
     *
     * Set CanUseRefactoredAeRoutines flag
     *
     * @param  string $id The Id of the Tenant. (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setUserCanUseRefactoredAeRoutinesTenantWithHttpInfo(
        string $id,
        string $userId,
        ?bool $canUseRefactoredAeRoutines = null,
        string $contentType = self::contentTypes['setUserCanUseRefactoredAeRoutinesTenant'][0]
    ...
    {
        $request = $this->setUserCanUseRefactoredAeRoutinesTenantRequest($id, $userId, $canUseRefactoredAeRoutines, $contentType);
    ...
    /**
     * Operation setUserCanUseRefactoredAeRoutinesTenantAsync
     *
     * Set CanUseRefactoredAeRoutines flag
     *
     * @param  string $id The Id of the Tenant. (required)
     ...
     * @return PromiseInterface
     */
    public function setUserCanUseRefactoredAeRoutinesTenantAsync(
        string $id,
        string $userId,
        ?bool $canUseRefactoredAeRoutines = null,
        string $contentType = self::contentTypes['setUserCanUseRefactoredAeRoutinesTenant'][0]
    ...
    {
        return $this->setUserCanUseRefactoredAeRoutinesTenantAsyncWithHttpInfo($id, $userId, $canUseRefactoredAeRoutines, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setUserCanUseRefactoredAeRoutinesTenantAsyncWithHttpInfo
     *
     * Set CanUseRefactoredAeRoutines flag
     *
     * @param  string $id The Id of the Tenant. (required)
     ...
     * @return PromiseInterface
     */
    public function setUserCanUseRefactoredAeRoutinesTenantAsyncWithHttpInfo(
        string $id,
        string $userId,
        ?bool $canUseRefactoredAeRoutines = null,
        string $contentType = self::contentTypes['setUserCanUseRefactoredAeRoutinesTenant'][0]
    ...
    /**
     * Create request for operation 'setUserCanUseRefactoredAeRoutinesTenant'
     *
     * @param  string $id The Id of the Tenant. (required)
     * @param  string $userId The Id of the User. (required)
     * @param  bool|null $canUseRefactoredAeRoutines The CanUseRefactoredAeRoutines flag for the User. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setUserCanUseRefactoredAeRoutinesTenantRequest(
        string $id,
        string $userId,
        ?bool $canUseRefactoredAeRoutines = null,
        string $contentType = self::contentTypes['setUserCanUseRefactoredAeRoutinesTenant'][0]
    ): Request
    {
        ...
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $id when calling setUserCanUseRefactoredAeRoutinesTenant'
            );
        }
        ...
        if ($userId === null || (is_array($userId) && count($userId) === 0)) {
            throw new InvalidArgumentException(
                'Missing the required parameter $userId when calling setUserCanUseRefactoredAeRoutinesTenant'
            );
        }



        $resourcePath = '/tenants/{id}/users/{userId}/refactoredaeroutine';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'canUseRefactoredAeRoutines', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
