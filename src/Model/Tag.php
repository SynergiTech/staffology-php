...
class Tag implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The unique code for this Tag
     *
     * @return $this
     */
    public function setCode(string $code): static
    {
        ...
        if ((mb_strlen($code) > 20)) {
            throw new InvalidArgumentException('invalid length for $code when calling Tag., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($code) < 1)) {
            throw new InvalidArgumentException('invalid length for $code when calling Tag., must be bigger than or equal to 1.');
        }
     ...
     * Sets title
     *
     * @param string $title The title for this Tag
     *
     * @return $this
     */
    public function setTitle(string $title): static
    {
        ...
        if ((mb_strlen($title) > 50)) {
            throw new InvalidArgumentException('invalid length for $title when calling Tag., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new InvalidArgumentException('invalid length for $title when calling Tag., must be bigger than or equal to 1.');
        }
     ...
     * Sets color
     *
     * @param string|null $color A color to used to represent this Tag, in hex format. ie 'ff0000'
     *
     * @return $this
     */
