...
/**
 * P11DLoanCollection Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class P11DLoanCollection implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'P11DLoanCollection';
    ...
    protected static array $openAPITypes = [
        'loan' => '\SynergiTech\Staffology\Model\P11DLoan[]',
        'typeLetter' => 'string'
    ];
    ...
    */
     ...
     * Gets loan
     *
     * @return \SynergiTech\Staffology\Model\P11DLoan[]|null
     */
     ...
     * Sets loan
     *
     * @param \SynergiTech\Staffology\Model\P11DLoan[]|null $loan loan
     *
     * @return $this
     */
    public function setLoan(?array $loan): static
    {
        if (is_null($loan)) {
            array_push($this->openAPINullablesSetToNull, 'loan');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('loan', $nullablesSetToNull);
            if ($index !== FALSE) {
