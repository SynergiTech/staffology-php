...
/**
 * ContractBankDetails Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractBankDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.BankDetails';
    ...
    */
    ...
    public function setBankName(?string $bankName): static
    {
        ...
        if (!is_null($bankName) && (mb_strlen($bankName) > 100)) {
            throw new InvalidArgumentException('invalid length for $bankName when calling ContractBankDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setBankBranch(?string $bankBranch): static
    {
        ...
        if (!is_null($bankBranch) && (mb_strlen($bankBranch) > 100)) {
            throw new InvalidArgumentException('invalid length for $bankBranch when calling ContractBankDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setBankReference(?string $bankReference): static
    {
        ...
        if (!is_null($bankReference) && (mb_strlen($bankReference) > 100)) {
            throw new InvalidArgumentException('invalid length for $bankReference when calling ContractBankDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setAccountName(?string $accountName): static
    {
        ...
        if (!is_null($accountName) && (mb_strlen($accountName) > 100)) {
            throw new InvalidArgumentException('invalid length for $accountName when calling ContractBankDetails., must be smaller than or equal to 100.');
        }
    ...
    public function setAccountNumber(?string $accountNumber): static
    {
        ...
        if (!is_null($accountNumber) && (!preg_match("/^\\d{8}$/", ObjectSerializer::toString($accountNumber)))) {
            throw new InvalidArgumentException("invalid value for \$accountNumber when calling ContractBankDetails., must conform to the pattern /^\\d{8}$/.");
        }
    ...
    public function setSortCode(?string $sortCode): static
    {
        ...
        if (!is_null($sortCode) && (!preg_match("/^(\\d{6}|\\d{2}-\\d{2}-\\d{2}|\\d{2} \\d{2} \\d{2})$/", ObjectSerializer::toString($sortCode)))) {
            throw new InvalidArgumentException("invalid value for \$sortCode when calling ContractBankDetails., must conform to the pattern /^(\\d{6}|\\d{2}-\\d{2}-\\d{2}|\\d{2} \\d{2} \\d{2})$/.");
        }
    ...
    public function setNote(?string $note): static
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 200)) {
            throw new InvalidArgumentException('invalid length for $note when calling ContractBankDetails., must be smaller than or equal to 200.');
        }
    ...
    public function setBuildingSocietyRollNumber(?string $buildingSocietyRollNumber): static
    {
        ...
        if (!is_null($buildingSocietyRollNumber) && (mb_strlen($buildingSocietyRollNumber) > 18)) {
            throw new InvalidArgumentException('invalid length for $buildingSocietyRollNumber when calling ContractBankDetails., must be smaller than or equal to 18.');
        }
        if (!is_null($buildingSocietyRollNumber) && (mb_strlen($buildingSocietyRollNumber) < 1)) {
            throw new InvalidArgumentException('invalid length for $buildingSocietyRollNumber when calling ContractBankDetails., must be bigger than or equal to 1.');
        }
        if (!is_null($buildingSocietyRollNumber) && (!preg_match("/^[a-zA-Z0-9\\s\/\\.-]+$/", ObjectSerializer::toString($buildingSocietyRollNumber)))) {
            throw new InvalidArgumentException("invalid value for \$buildingSocietyRollNumber when calling ContractBankDetails., must conform to the pattern /^[a-zA-Z0-9\\s\/\\.-]+$/.");
        }
