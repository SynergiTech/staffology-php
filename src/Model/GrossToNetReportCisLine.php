...
/**
 * GrossToNetReportCisLine Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GrossToNetReportCisLine implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GrossToNetReportCisLine';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('labour', $data ?? [], null);
    ...
    */
     ...
     * @return float|null
     */
    public function getLabour(): ?float
    {
        return $this->container['labour'];
    }

    /**
     * Sets labour
     *
     * @param float|null $labour labour
     *
     * @return $this
     */
    public function setLabour(?float $labour): static
    {
        if (is_null($labour)) {
            throw new InvalidArgumentException('non-nullable labour cannot be null');
        }
        $this->container['labour'] = $labour;
     ...
     * Sets materials
     *
     * @param float|null $materials materials
     *
     * @return $this
     */
    public function setMaterials(?float $materials): static
    {
     ...
     * Sets cisDeduction
     *
     * @param float|null $cisDeduction cisDeduction
     *
     * @return $this
     */
     ...
     * Sets umbrellaFee
     *
     * @param float|null $umbrellaFee umbrellaFee
     *
     * @return $this
     */
