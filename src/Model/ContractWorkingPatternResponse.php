...
/**
 * ContractWorkingPatternResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractWorkingPatternResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.WorkingPatternResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'shiftWorkingPatternDays' => '\SynergiTech\Staffology\Model\ContractShiftWorkingPatternDayResponse[]'
    ];
    ...
    */
    ...
    public function setTitle(string $title): static
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new InvalidArgumentException('invalid length for $title when calling ContractWorkingPatternResponse., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new InvalidArgumentException('invalid length for $title when calling ContractWorkingPatternResponse., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param \DateTime[]|null $bankHolidayDates [readonly] The dates that are classed as Bank Holidays for this Working Pattern
     *
     * @return $this
     */
     ...
     *
     * @return \SynergiTech\Staffology\Model\ContractShiftWorkingPatternDayResponse[]|null
     */
     ...
     *
     * @param \SynergiTech\Staffology\Model\ContractShiftWorkingPatternDayResponse[]|null $shiftWorkingPatternDays shiftWorkingPatternDays
     *
     * @return $this
     */
