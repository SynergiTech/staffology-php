...
/**
 * ExbP11dEmployee Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ExbP11dEmployee implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ExbP11dEmployee';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dirInd', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('wksNo', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getDirInd(): ?string
    {
        return $this->container['dirInd'];
    }
     ...
     * @return $this
     */
    public function setDirInd(?string $dirInd): static
    {
        if (is_null($dirInd)) {
            array_push($this->openAPINullablesSetToNull, 'dirInd');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dirInd', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['dirInd'] = $dirInd;
     ...
     * @return string|null
     */
    public function getWksNo(): ?string
    {
        return $this->container['wksNo'];
    }

    /**
     * Sets wksNo
     *
     * @param string|null $wksNo wksNo
     *
     * @return $this
     */
    public function setWksNo(?string $wksNo): static
    {
        if (is_null($wksNo)) {
            array_push($this->openAPINullablesSetToNull, 'wksNo');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('wksNo', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['wksNo'] = $wksNo;
