 ...
 */
class FpsCarFuel implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FpsCarFuel';
    ...
    */
     ...
     * @return $this
     */
    public function setProvided(?string $provided): static
    {
        if (is_null($provided)) {
            array_push($this->openAPINullablesSetToNull, 'provided');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('provided', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets withdrawn
     *
     * @param string|null $withdrawn withdrawn
     *
     * @return $this
     */
    public function setWithdrawn(?string $withdrawn): static
    {
        if (is_null($withdrawn)) {
            array_push($this->openAPINullablesSetToNull, 'withdrawn');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('withdrawn', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
