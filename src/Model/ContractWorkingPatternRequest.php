...
/**
 * ContractWorkingPatternRequest Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractWorkingPatternRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.WorkingPatternRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'sat' => 'float',
        'sun' => 'float',
        'monIsWorkingDay' => 'bool',
        'tueIsWorkingDay' => 'bool',
        'wedIsWorkingDay' => 'bool',
        'thuIsWorkingDay' => 'bool',
        'friIsWorkingDay' => 'bool',
        'satIsWorkingDay' => 'bool',
        'sunIsWorkingDay' => 'bool',
        'totalHours' => 'float',
        ...
        'shiftWorkingPatternDays' => '\SynergiTech\Staffology\Model\ContractShiftWorkingPatternDayRequest[]'
    ];
    ...
    protected static array $openAPIFormats = [
        ...
        'sat' => 'double',
        'sun' => 'double',
        'monIsWorkingDay' => null,
        'tueIsWorkingDay' => null,
        'wedIsWorkingDay' => null,
        'thuIsWorkingDay' => null,
        'friIsWorkingDay' => null,
        'satIsWorkingDay' => null,
        'sunIsWorkingDay' => null,
        'totalHours' => 'double',
    ...
    protected static array $openAPINullables = [
        ...
        'sat' => false,
        'sun' => false,
        'monIsWorkingDay' => false,
        'tueIsWorkingDay' => false,
        'wedIsWorkingDay' => false,
        'thuIsWorkingDay' => false,
        'friIsWorkingDay' => false,
        'satIsWorkingDay' => false,
        'sunIsWorkingDay' => false,
        'totalHours' => false,
    ...
    protected static array $attributeMap = [
        ...
        'sat' => 'sat',
        'sun' => 'sun',
        'monIsWorkingDay' => 'monIsWorkingDay',
        'tueIsWorkingDay' => 'tueIsWorkingDay',
        'wedIsWorkingDay' => 'wedIsWorkingDay',
        'thuIsWorkingDay' => 'thuIsWorkingDay',
        'friIsWorkingDay' => 'friIsWorkingDay',
        'satIsWorkingDay' => 'satIsWorkingDay',
        'sunIsWorkingDay' => 'sunIsWorkingDay',
    ...
    protected static array $setters = [
        ...
        'sat' => 'setSat',
        'sun' => 'setSun',
        'monIsWorkingDay' => 'setMonIsWorkingDay',
        'tueIsWorkingDay' => 'setTueIsWorkingDay',
        'wedIsWorkingDay' => 'setWedIsWorkingDay',
        'thuIsWorkingDay' => 'setThuIsWorkingDay',
        'friIsWorkingDay' => 'setFriIsWorkingDay',
        'satIsWorkingDay' => 'setSatIsWorkingDay',
        'sunIsWorkingDay' => 'setSunIsWorkingDay',
    ...
    protected static array $getters = [
        ...
        'sat' => 'getSat',
        'sun' => 'getSun',
        'monIsWorkingDay' => 'getMonIsWorkingDay',
        'tueIsWorkingDay' => 'getTueIsWorkingDay',
        'wedIsWorkingDay' => 'getWedIsWorkingDay',
        'thuIsWorkingDay' => 'getThuIsWorkingDay',
        'friIsWorkingDay' => 'getFriIsWorkingDay',
        'satIsWorkingDay' => 'getSatIsWorkingDay',
        'sunIsWorkingDay' => 'getSunIsWorkingDay',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('monIsWorkingDay', $data ?? [], null);
        $this->setIfExists('tueIsWorkingDay', $data ?? [], null);
        $this->setIfExists('wedIsWorkingDay', $data ?? [], null);
        $this->setIfExists('thuIsWorkingDay', $data ?? [], null);
        $this->setIfExists('friIsWorkingDay', $data ?? [], null);
        $this->setIfExists('satIsWorkingDay', $data ?? [], null);
        $this->setIfExists('sunIsWorkingDay', $data ?? [], null);
    ...
    */
    ...
    public function setTitle(string $title): static
    {
        ...
        if ((mb_strlen($title) > 100)) {
            throw new InvalidArgumentException('invalid length for $title when calling ContractWorkingPatternRequest., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($title) < 1)) {
            throw new InvalidArgumentException('invalid length for $title when calling ContractWorkingPatternRequest., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets monIsWorkingDay
     *
     * @return bool|null
     */
    public function getMonIsWorkingDay(): ?bool
    {
        return $this->container['monIsWorkingDay'];
    }

    /**
     * Sets monIsWorkingDay
     *
     * @param bool|null $monIsWorkingDay monIsWorkingDay
     *
     * @return $this
     */
    public function setMonIsWorkingDay(?bool $monIsWorkingDay): static
    {
        if (is_null($monIsWorkingDay)) {
            throw new InvalidArgumentException('non-nullable monIsWorkingDay cannot be null');
        }
        $this->container['monIsWorkingDay'] = $monIsWorkingDay;

        return $this;
    }

    /**
     * Gets tueIsWorkingDay
     *
     * @return bool|null
     */
    public function getTueIsWorkingDay(): ?bool
    {
        return $this->container['tueIsWorkingDay'];
    }

    /**
     * Sets tueIsWorkingDay
     *
     * @param bool|null $tueIsWorkingDay tueIsWorkingDay
     *
     * @return $this
     */
    public function setTueIsWorkingDay(?bool $tueIsWorkingDay): static
    {
        if (is_null($tueIsWorkingDay)) {
            throw new InvalidArgumentException('non-nullable tueIsWorkingDay cannot be null');
        }
        $this->container['tueIsWorkingDay'] = $tueIsWorkingDay;

        return $this;
    }

    /**
     * Gets wedIsWorkingDay
     *
     * @return bool|null
     */
    public function getWedIsWorkingDay(): ?bool
    {
        return $this->container['wedIsWorkingDay'];
    }

    /**
     * Sets wedIsWorkingDay
     *
     * @param bool|null $wedIsWorkingDay wedIsWorkingDay
     *
     * @return $this
     */
    public function setWedIsWorkingDay(?bool $wedIsWorkingDay): static
    {
        if (is_null($wedIsWorkingDay)) {
            throw new InvalidArgumentException('non-nullable wedIsWorkingDay cannot be null');
        }
        $this->container['wedIsWorkingDay'] = $wedIsWorkingDay;

        return $this;
    }

    /**
     * Gets thuIsWorkingDay
     *
     * @return bool|null
     */
    public function getThuIsWorkingDay(): ?bool
    {
        return $this->container['thuIsWorkingDay'];
    }

    /**
     * Sets thuIsWorkingDay
     *
     * @param bool|null $thuIsWorkingDay thuIsWorkingDay
     *
     * @return $this
     */
    public function setThuIsWorkingDay(?bool $thuIsWorkingDay): static
    {
        if (is_null($thuIsWorkingDay)) {
            throw new InvalidArgumentException('non-nullable thuIsWorkingDay cannot be null');
        }
        $this->container['thuIsWorkingDay'] = $thuIsWorkingDay;

        return $this;
    }

    /**
     * Gets friIsWorkingDay
     *
     * @return bool|null
     */
    public function getFriIsWorkingDay(): ?bool
    {
        return $this->container['friIsWorkingDay'];
    }

    /**
     * Sets friIsWorkingDay
     *
     * @param bool|null $friIsWorkingDay friIsWorkingDay
     *
     * @return $this
     */
    public function setFriIsWorkingDay(?bool $friIsWorkingDay): static
    {
        if (is_null($friIsWorkingDay)) {
            throw new InvalidArgumentException('non-nullable friIsWorkingDay cannot be null');
        }
        $this->container['friIsWorkingDay'] = $friIsWorkingDay;

        return $this;
    }

    /**
     * Gets satIsWorkingDay
     *
     * @return bool|null
     */
    public function getSatIsWorkingDay(): ?bool
    {
        return $this->container['satIsWorkingDay'];
    }

    /**
     * Sets satIsWorkingDay
     *
     * @param bool|null $satIsWorkingDay satIsWorkingDay
     *
     * @return $this
     */
    public function setSatIsWorkingDay(?bool $satIsWorkingDay): static
    {
        if (is_null($satIsWorkingDay)) {
            throw new InvalidArgumentException('non-nullable satIsWorkingDay cannot be null');
        }
        $this->container['satIsWorkingDay'] = $satIsWorkingDay;

        return $this;
    }

    /**
     * Gets sunIsWorkingDay
     *
     * @return bool|null
     */
    public function getSunIsWorkingDay(): ?bool
    {
        return $this->container['sunIsWorkingDay'];
    }

    /**
     * Sets sunIsWorkingDay
     *
     * @param bool|null $sunIsWorkingDay sunIsWorkingDay
     *
     * @return $this
     */
    public function setSunIsWorkingDay(?bool $sunIsWorkingDay): static
    {
        if (is_null($sunIsWorkingDay)) {
            throw new InvalidArgumentException('non-nullable sunIsWorkingDay cannot be null');
        }
        $this->container['sunIsWorkingDay'] = $sunIsWorkingDay;
     ...
     * Sets totalHours
     *
     * @param float|null $totalHours totalHours
     *
     * @return $this
     */
     ...
     *
     * @return \SynergiTech\Staffology\Model\ContractShiftWorkingPatternDayRequest[]|null
     */
     ...
     *
     * @param \SynergiTech\Staffology\Model\ContractShiftWorkingPatternDayRequest[]|null $shiftWorkingPatternDays shiftWorkingPatternDays
     *
     * @return $this
     */
