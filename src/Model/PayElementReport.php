...
/**
 * PayElementReport Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PayElementReport implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PayElementReport';
    ...
    protected static array $openAPITypes = [
        'lines' => '\SynergiTech\Staffology\Model\PayElementReportLine[]',
        'payCodeTotals' => 'array<string,float>',
    ...
    protected static array $setters = [
        'lines' => 'setLines',
        'payCodeTotals' => 'setPayCodeTotals',
    ...
    protected static array $getters = [
        'lines' => 'getLines',
        'payCodeTotals' => 'getPayCodeTotals',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payCodeTotals', $data ?? [], null);
    ...
    */
     ...
     * Gets lines
     *
     * @return \SynergiTech\Staffology\Model\PayElementReportLine[]|null
     */
     ...
     * Sets lines
     *
     * @param \SynergiTech\Staffology\Model\PayElementReportLine[]|null $lines lines
     *
     * @return $this
     */
     ...
     */
    public function getPayCodeTotals(): ?array
    {
        return $this->container['payCodeTotals'];
    }

    /**
     * Sets payCodeTotals
     *
     * @param array<string,float>|null $payCodeTotals payCodeTotals
     *
     * @return $this
     */
    public function setPayCodeTotals(?array $payCodeTotals): static
    {
        if (is_null($payCodeTotals)) {
            array_push($this->openAPINullablesSetToNull, 'payCodeTotals');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payCodeTotals', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['payCodeTotals'] = $payCodeTotals;
