    ...
    */
    ...
    public function setWorkplacePostcode(?string $workplacePostcode): static
    {
        ...
        if (!is_null($workplacePostcode) && (mb_strlen($workplacePostcode) > 10)) {
            throw new InvalidArgumentException('invalid length for $workplacePostcode when calling ContractEmploymentDetailsRequest., must be smaller than or equal to 10.');
        }
