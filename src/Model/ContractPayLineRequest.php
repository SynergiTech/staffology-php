...
class ContractPayLineRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    protected static array $openAPIFormats = [
        'analysisCategoryCodesJson' => null,
        'value' => 'double',
        'rate' => 'double',
        'multiplier' => 'double',
        'description' => null,
    ...
    protected static array $openAPINullables = [
        'analysisCategoryCodesJson' => true,
        'value' => false,
        'rate' => true,
        'multiplier' => true,
        'description' => true,
    ...
    protected static array $attributeMap = [
        'analysisCategoryCodesJson' => 'analysisCategoryCodesJson',
        'value' => 'value',
        'rate' => 'rate',
    ...
    protected static array $setters = [
        'analysisCategoryCodesJson' => 'setAnalysisCategoryCodesJson',
        'value' => 'setValue',
        'rate' => 'setRate',
    ...
    protected static array $getters = [
        'analysisCategoryCodesJson' => 'getAnalysisCategoryCodesJson',
        'value' => 'getValue',
        'rate' => 'getRate',
    ...
    {
        $this->setIfExists('analysisCategoryCodesJson', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets analysisCategoryCodesJson
     *
     * @return string|null
     */
    public function getAnalysisCategoryCodesJson(): ?string
    {
        return $this->container['analysisCategoryCodesJson'];
    }

    /**
     * Sets analysisCategoryCodesJson
     *
     * @param string|null $analysisCategoryCodesJson Analysis category id and analysiscategoryCode json
     *
     * @return $this
     */
    public function setAnalysisCategoryCodesJson(?string $analysisCategoryCodesJson): static
    {
        if (is_null($analysisCategoryCodesJson)) {
            array_push($this->openAPINullablesSetToNull, 'analysisCategoryCodesJson');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('analysisCategoryCodesJson', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['analysisCategoryCodesJson'] = $analysisCategoryCodesJson;
    ...
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ContractPayLineRequest., must be smaller than or equal to 100.');
        }
