...
/**
 * HolidayReport Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class HolidayReport implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HolidayReport';
    ...
    protected static array $openAPITypes = [
        'accrualsReport' => 'bool',
        'accrualsHrsReport' => 'bool',
        'employer' => '\SynergiTech\Staffology\Model\Item',
        'lines' => '\SynergiTech\Staffology\Model\HolidayReportLine[]',
    ...
    protected static array $openAPINullables = [
        'accrualsReport' => false,
        'accrualsHrsReport' => false,
        'employer' => false,
        'lines' => true,
        'report' => false,
        'taxYear' => false,
    ...
    protected static array $attributeMap = [
        'accrualsReport' => 'accrualsReport',
        'accrualsHrsReport' => 'accrualsHrsReport',
        'employer' => 'employer',
        'lines' => 'lines',
        'report' => 'report',
        'taxYear' => 'taxYear',
    ...
    protected static array $setters = [
        'accrualsReport' => 'setAccrualsReport',
        'accrualsHrsReport' => 'setAccrualsHrsReport',
    ...
    protected static array $getters = [
        'accrualsReport' => 'getAccrualsReport',
        'accrualsHrsReport' => 'getAccrualsHrsReport',
    ...
    {
        $this->setIfExists('accrualsReport', $data ?? [], null);
        $this->setIfExists('accrualsHrsReport', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getAccrualsReport(): ?bool
    {
        return $this->container['accrualsReport'];
    }

    /**
     * Sets accrualsReport
     *
     * @param bool|null $accrualsReport accrualsReport
     *
     * @return $this
     */
    public function setAccrualsReport(?bool $accrualsReport): static
    {
        if (is_null($accrualsReport)) {
            throw new InvalidArgumentException('non-nullable accrualsReport cannot be null');
        }
        $this->container['accrualsReport'] = $accrualsReport;

        return $this;
    }

    /**
     * Gets accrualsHrsReport
     *
     * @return bool|null
     */
    public function getAccrualsHrsReport(): ?bool
    {
        return $this->container['accrualsHrsReport'];
    }

    /**
     * Sets accrualsHrsReport
     *
     * @param bool|null $accrualsHrsReport accrualsHrsReport
     *
     * @return $this
     */
    public function setAccrualsHrsReport(?bool $accrualsHrsReport): static
    {
        if (is_null($accrualsHrsReport)) {
            throw new InvalidArgumentException('non-nullable accrualsHrsReport cannot be null');
        }
        $this->container['accrualsHrsReport'] = $accrualsHrsReport;
     ...
     * Gets lines
     *
     * @return \SynergiTech\Staffology\Model\HolidayReportLine[]|null
     */
     ...
     * Sets lines
     *
     * @param \SynergiTech\Staffology\Model\HolidayReportLine[]|null $lines lines
     *
     * @return $this
     */
