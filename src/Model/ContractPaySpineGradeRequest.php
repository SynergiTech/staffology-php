...
/**
 * ContractPaySpineGradeRequest Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractPaySpineGradeRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.PaySpineGradeRequest';
    ...
    */
     ...
     *
     * @param string|null $lowerPointUniqueId Id of lower spinal point to be used.
     *
     * @return $this
     */
     ...
     *
     * @param string|null $upperPointUniqueId Id of upper spinal point to be used.
     *
     * @return $this
     */
     ...
     *
     * @param float|null $holidayEntitlement The number of holidays entitled to this pay spine grade.
     *
     * @return $this
     */
