...
class ReportTemplate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ReportTemplate';
    ...
    */
    ...
    public function setTemplateName(string $templateName): static
    {
        ...
        if ((mb_strlen($templateName) < 1)) {
            throw new InvalidArgumentException('invalid length for $templateName when calling ReportTemplate., must be bigger than or equal to 1.');
        }
