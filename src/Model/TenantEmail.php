 ...
 */
class TenantEmail implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TenantEmail';
    ...
    */
    ...
    public function setToName(string $toName): static
    {
        ...
        if ((mb_strlen($toName) > 150)) {
            throw new InvalidArgumentException('invalid length for $toName when calling TenantEmail., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($toName) < 1)) {
            throw new InvalidArgumentException('invalid length for $toName when calling TenantEmail., must be bigger than or equal to 1.');
        }
    ...
    public function setToEmail(string $toEmail): static
    {
        ...
        if ((mb_strlen($toEmail) > 150)) {
            throw new InvalidArgumentException('invalid length for $toEmail when calling TenantEmail., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($toEmail) < 1)) {
            throw new InvalidArgumentException('invalid length for $toEmail when calling TenantEmail., must be bigger than or equal to 1.');
        }
    ...
    public function setSubject(string $subject): static
    {
        ...
        if ((mb_strlen($subject) > 150)) {
            throw new InvalidArgumentException('invalid length for $subject when calling TenantEmail., must be smaller than or equal to 150.');
        }
        if ((mb_strlen($subject) < 1)) {
            throw new InvalidArgumentException('invalid length for $subject when calling TenantEmail., must be bigger than or equal to 1.');
        }
    ...
    public function setButtonText(?string $buttonText): static
    {
        ...
        if (!is_null($buttonText) && (mb_strlen($buttonText) > 100)) {
            throw new InvalidArgumentException('invalid length for $buttonText when calling TenantEmail., must be smaller than or equal to 100.');
        }
    ...
    public function setButtonLink(?string $buttonLink): static
    {
        ...
        if (!is_null($buttonLink) && (mb_strlen($buttonLink) > 250)) {
            throw new InvalidArgumentException('invalid length for $buttonLink when calling TenantEmail., must be smaller than or equal to 250.');
        }
    ...
    public function setBodyPreview(?string $bodyPreview): static
    {
        ...
        if (!is_null($bodyPreview) && (mb_strlen($bodyPreview) > 100)) {
            throw new InvalidArgumentException('invalid length for $bodyPreview when calling TenantEmail., must be smaller than or equal to 100.');
        }
