...
/**
 * PartnerDetails Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PartnerDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PartnerDetails';
    ...
    */
    ...
    public function setFirstName(?string $firstName): static
    {
        ...
        if (!is_null($firstName) && (mb_strlen($firstName) > 35)) {
            throw new InvalidArgumentException('invalid length for $firstName when calling PartnerDetails., must be smaller than or equal to 35.');
        }
    ...
    public function setInitials(?string $initials): static
    {
        ...
        if (!is_null($initials) && (mb_strlen($initials) > 30)) {
            throw new InvalidArgumentException('invalid length for $initials when calling PartnerDetails., must be smaller than or equal to 30.');
        }
    ...
    public function setLastName(?string $lastName): static
    {
        ...
        if (!is_null($lastName) && (mb_strlen($lastName) > 35)) {
            throw new InvalidArgumentException('invalid length for $lastName when calling PartnerDetails., must be smaller than or equal to 35.');
        }
    ...
    public function setNiNumber(?string $niNumber): static
    {
        ...
        if (!is_null($niNumber) && (mb_strlen($niNumber) > 15)) {
            throw new InvalidArgumentException('invalid length for $niNumber when calling PartnerDetails., must be smaller than or equal to 15.');
        }
