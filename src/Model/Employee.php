...
class Employee implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Employee';
    ...
    protected static array $openAPITypes = [
        ...
        'leaveHolidayAccrualDefaultRateType' => '\SynergiTech\Staffology\Model\HolidayAccrualDefaultRateType',
        'id' => 'string',
        ...
        'autoEnrolment' => '\SynergiTech\Staffology\Model\AutoEnrolment',
        'leaveSettings' => '\SynergiTech\Staffology\Model\LeaveSettings',
        'rightToWork' => '\SynergiTech\Staffology\Model\RightToWork',
    ...
    protected static array $openAPIFormats = [
        ...
        'leaveHolidayAccrualDefaultRateType' => null,
        'id' => 'uuid',
    ...
    protected static array $openAPINullables = [
        ...
        'leaveHolidayAccrualDefaultRateType' => false,
        'id' => false,
    ...
    protected static array $attributeMap = [
        ...
        'leaveHolidayAccrualDefaultRateType' => 'leaveHolidayAccrualDefaultRateType',
        'id' => 'id',
    ...
    protected static array $setters = [
        ...
        'leaveHolidayAccrualDefaultRateType' => 'setLeaveHolidayAccrualDefaultRateType',
        'id' => 'setId',
    ...
    protected static array $getters = [
        ...
        'leaveHolidayAccrualDefaultRateType' => 'getLeaveHolidayAccrualDefaultRateType',
        'id' => 'getId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('leaveHolidayAccrualDefaultRateType', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets leaveHolidayAccrualDefaultRateType
     *
     * @return \SynergiTech\Staffology\Model\HolidayAccrualDefaultRateType|null
     */
    public function getLeaveHolidayAccrualDefaultRateType(): ?\SynergiTech\Staffology\Model\HolidayAccrualDefaultRateType
    {
        return $this->container['leaveHolidayAccrualDefaultRateType'];
    }

    /**
     * Sets leaveHolidayAccrualDefaultRateType
     *
     * @param \SynergiTech\Staffology\Model\HolidayAccrualDefaultRateType|null $leaveHolidayAccrualDefaultRateType leaveHolidayAccrualDefaultRateType
     *
     * @return $this
     */
    public function setLeaveHolidayAccrualDefaultRateType(?\SynergiTech\Staffology\Model\HolidayAccrualDefaultRateType $leaveHolidayAccrualDefaultRateType): static
    {
        if (is_null($leaveHolidayAccrualDefaultRateType)) {
            throw new InvalidArgumentException('non-nullable leaveHolidayAccrualDefaultRateType cannot be null');
        }
        $this->container['leaveHolidayAccrualDefaultRateType'] = $leaveHolidayAccrualDefaultRateType;
     ...
     * Gets autoEnrolment
     *
     * @return \SynergiTech\Staffology\Model\AutoEnrolment|null
     */
    public function getAutoEnrolment(): ?\SynergiTech\Staffology\Model\AutoEnrolment
    {
     ...
     * Sets autoEnrolment
     *
     * @param \SynergiTech\Staffology\Model\AutoEnrolment|null $autoEnrolment autoEnrolment
     *
     * @return $this
     */
    public function setAutoEnrolment(?\SynergiTech\Staffology\Model\AutoEnrolment $autoEnrolment): static
    {
     ...
     * Gets rightToWork
     *
     * @return \SynergiTech\Staffology\Model\RightToWork|null
     */
    public function getRightToWork(): ?\SynergiTech\Staffology\Model\RightToWork
    {
     ...
     * Sets rightToWork
     *
     * @param \SynergiTech\Staffology\Model\RightToWork|null $rightToWork rightToWork
     *
     * @return $this
     */
    public function setRightToWork(?\SynergiTech\Staffology\Model\RightToWork $rightToWork): static
    {
     ...
     *
     * @param bool|null $aeNotEnroledWarning [readonly] If true then the employee should be enrolled in an Auto Enrolment Qualifying pension but isn't
     *
     * @return $this
     */
     ...
     * Sets sourceSystemId
     *
     * @param string|null $sourceSystemId [readonly] Can only be given a value when the employee is created. It can then never be changed.  Used by external systems so they can store an immutable reference
     *
     * @return $this
     */
    public function setSourceSystemId(?string $sourceSystemId): static
    {
        ...
        if (!is_null($sourceSystemId) && (mb_strlen($sourceSystemId) > 50)) {
            throw new InvalidArgumentException('invalid length for $sourceSystemId when calling Employee., must be smaller than or equal to 50.');
        }
