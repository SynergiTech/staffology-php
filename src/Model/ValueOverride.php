...
/**
 * ValueOverride Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ValueOverride implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ValueOverride';
    ...
    protected static array $openAPITypes = [
        'type' => '\SynergiTech\Staffology\Model\PayrollValueType',
        'value' => 'float',
        'originalValue' => 'float',
        'note' => 'string',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['note']) && (mb_strlen($this->container['note']) > 150)) {
            $invalidProperties[] = "invalid value for 'note', the character length must be smaller than or equal to 150.";
        }
     ...
     * Gets type
     *
     * @return \SynergiTech\Staffology\Model\PayrollValueType|null
     */
    public function getType(): ?\SynergiTech\Staffology\Model\PayrollValueType
    {
     ...
     * Sets type
     *
     * @param \SynergiTech\Staffology\Model\PayrollValueType|null $type type
     *
     * @return $this
     */
    public function setType(?\SynergiTech\Staffology\Model\PayrollValueType $type): static
    {
        if (is_null($type)) {
     ...
     * Sets value
     *
     * @param float|null $value The value to use in place of the original value
     *
     * @return $this
     */
     ...
     * Sets originalValue
     *
     * @param float|null $originalValue [readonly] The original value
     *
     * @return $this
     */
     ...
     * Sets note
     *
     * @param string|null $note The reason given for the override
     *
     * @return $this
     */
    public function setNote(?string $note): static
    {
        ...
        if (!is_null($note) && (mb_strlen($note) > 150)) {
            throw new InvalidArgumentException('invalid length for $note when calling ValueOverride., must be smaller than or equal to 150.');
        }
     ...
     *
     * @param string|null $attachmentOrderId The Id of the AttachmentOrder. Only relevant if the Type is set to AttachmentOrderDeductions
     *
     * @return $this
     */
     ...
     * Sets pensionId
     *
     * @param string|null $pensionId The Id of the associated Pension. Only included if the Code is PENSION, PENSIONSS or PENSIONRAS
     *
     * @return $this
     */
     ...
     * Sets leaveId
     *
     * @param string|null $leaveId The Id of the associated Leave.
     *
     * @return $this
     */
