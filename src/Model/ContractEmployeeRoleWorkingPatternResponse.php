<?php
/**
 * ContractEmployeeRoleWorkingPatternResponse
 *
 * PHP version 8.1
 *
...
/**
 * ContractEmployeeRoleWorkingPatternResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractEmployeeRoleWorkingPatternResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.EmployeeRoleWorkingPatternResponse';
    ...
    protected static array $attributeMap = [
        ...
        'workingPatternUniqueId' => 'workingPatternUniqueId'
    ];
    ...
    protected static array $setters = [
        ...
        'workingPatternUniqueId' => 'setWorkingPatternUniqueId'
    ];
    ...
    protected static array $getters = [
        ...
        'workingPatternUniqueId' => 'getWorkingPatternUniqueId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('workingPatternUniqueId', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets uniqueId
     *
     * @param string|null $uniqueId The UniqueId of the model.
     *
     * @return $this
     */
    ...
    public function setEffectiveTo(?\DateTime $effectiveTo): static
    {
        if (is_null($effectiveTo)) {
            throw new InvalidArgumentException('non-nullable effectiveTo cannot be null');
        }
    ...
    /**
     * Gets workingPatternUniqueId
     *
     * @return string|null
     */
    public function getWorkingPatternUniqueId(): ?string
    {
        return $this->container['workingPatternUniqueId'];
    }

    /**
     * Sets workingPatternUniqueId
     *
     * @param string|null $workingPatternUniqueId The UniqueId of the Working Pattern.
     *
     * @return $this
     */
    public function setWorkingPatternUniqueId(?string $workingPatternUniqueId): static
    {
        if (is_null($workingPatternUniqueId)) {
            throw new InvalidArgumentException('non-nullable workingPatternUniqueId cannot be null');
        }
        $this->container['workingPatternUniqueId'] = $workingPatternUniqueId;
