...
/**
 * ContractRtiEmployeeAddress Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractRtiEmployeeAddress implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.RtiEmployeeAddress';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('postCode', $data ?? [], null);
        $this->setIfExists('ukPostcode', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getUkPostcode(): ?string
    {
        return $this->container['ukPostcode'];
    }

    /**
     * Sets ukPostcode
     *
     * @param string|null $ukPostcode ukPostcode
     *
     * @return $this
     */
    public function setUkPostcode(?string $ukPostcode): static
    {
        if (is_null($ukPostcode)) {
            array_push($this->openAPINullablesSetToNull, 'ukPostcode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ukPostcode', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ukPostcode'] = $ukPostcode;
