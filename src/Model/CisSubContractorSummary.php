...
/**
 * CisSubContractorSummary Class Doc Comment
 *
 * @description 
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 ...
 */
class CisSubContractorSummary implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CisSubContractorSummary';
    ...
    */
     ...
     *
     * @param string[]|null $validationMessage validationMessage
     *
     * @return $this
     */
    public function setValidationMessage(?array $validationMessage): static
    {
        if (is_null($validationMessage)) {
            array_push($this->openAPINullablesSetToNull, 'validationMessage');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('validationMessage', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
