...
/**
 * ContractEmploymentDetailsResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractEmploymentDetailsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.EmploymentDetailsResponse';
    ...
    protected static array $openAPITypes = [
        'cis' => '\SynergiTech\Staffology\Model\ContractCisDetailsResponse',
        'department' => '\SynergiTech\Staffology\Model\ContractDepartmentResponse',
    ...
    */
     ...
     * Gets cis
     *
     * @return \SynergiTech\Staffology\Model\ContractCisDetailsResponse|null
     */
    public function getCis(): ?\SynergiTech\Staffology\Model\ContractCisDetailsResponse
    {
     ...
     * Sets cis
     *
     * @param \SynergiTech\Staffology\Model\ContractCisDetailsResponse|null $cis cis
     *
     * @return $this
     */
    public function setCis(?\SynergiTech\Staffology\Model\ContractCisDetailsResponse $cis): static
    {
        if (is_null($cis)) {
     ...
     * Gets department
     *
     * @return \SynergiTech\Staffology\Model\ContractDepartmentResponse|null
     */
    public function getDepartment(): ?\SynergiTech\Staffology\Model\ContractDepartmentResponse
    {
     ...
     * Sets department
     *
     * @param \SynergiTech\Staffology\Model\ContractDepartmentResponse|null $department department
     *
     * @return $this
     */
    public function setDepartment(?\SynergiTech\Staffology\Model\ContractDepartmentResponse $department): static
    {
     ...
     *
     * @param bool|null $includeSecondedInfoOnStarter includeSecondedInfoOnStarter
     *
     * @return $this
     */
    ...
    public function setPayrollCode(string $payrollCode): static
    {
        ...
        if ((mb_strlen($payrollCode) > 35)) {
            throw new InvalidArgumentException('invalid length for $payrollCode when calling ContractEmploymentDetailsResponse., must be smaller than or equal to 35.');
        }
        if ((mb_strlen($payrollCode) < 1)) {
            throw new InvalidArgumentException('invalid length for $payrollCode when calling ContractEmploymentDetailsResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setJobTitle(?string $jobTitle): static
    {
        ...
        if (!is_null($jobTitle) && (mb_strlen($jobTitle) > 120)) {
            throw new InvalidArgumentException('invalid length for $jobTitle when calling ContractEmploymentDetailsResponse., must be smaller than or equal to 120.');
        }
     ...
     *
     * @param string|null $workplacePostcode Set the workplace postcode, ensuring it is no longer than 10 characters.
     *
     * @return $this
     */
    public function setWorkplacePostcode(?string $workplacePostcode): static
    {
        ...
        if (!is_null($workplacePostcode) && (mb_strlen($workplacePostcode) > 10)) {
            throw new InvalidArgumentException('invalid length for $workplacePostcode when calling ContractEmploymentDetailsResponse., must be smaller than or equal to 10.');
        }
    ...
    public function setForcePreviousPayrollCode(?string $forcePreviousPayrollCode): static
    {
        ...
        if (!is_null($forcePreviousPayrollCode) && (mb_strlen($forcePreviousPayrollCode) > 35)) {
            throw new InvalidArgumentException('invalid length for $forcePreviousPayrollCode when calling ContractEmploymentDetailsResponse., must be smaller than or equal to 35.');
        }
