...
/**
 * ContractPayLineResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractPayLineResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.PayLineResponse';
    ...
    */
     ...
     *
     * @param string|null $initialBackPayPublicPayRunId [readonly] Used to mark the first payrun where this payline has been payrolled for backpay
     *
     * @return $this
     */
     ...
     * Sets description
     *
     * @param string|null $description A freeform description to accompany this line. It will be displayed on the payslip.
     *
     * @return $this
     */
    public function setDescription(?string $description): static
    {
        ...
        if (!is_null($description) && (mb_strlen($description) > 100)) {
            throw new InvalidArgumentException('invalid length for $description when calling ContractPayLineResponse., must be smaller than or equal to 100.');
        }
     ...
     *
     * @param float|null $netToGrossDiscrepancy The discrepancy between the targeted and the calculated grossed up value durig a net to gross calculation.
     *
     * @return $this
     */
     ...
     * Sets effectiveFrom
     *
     * @param \DateTime|null $effectiveFrom The date the payline starts being calculated in payrun
     *
     * @return $this
     */
     ...
     * Sets effectiveTo
     *
     * @param \DateTime|null $effectiveTo The date the payline stops being calculated in payrun
     *
     * @return $this
     */
     ...
     * Sets earnedFrom
     *
     * @param \DateTime|null $earnedFrom earnedFrom
     *
     * @return $this
     */
     ...
     * Sets earnedTo
     *
     * @param \DateTime|null $earnedTo earnedTo
     *
     * @return $this
     */
     ...
     * Sets department
     *
     * @param string|null $department Department code which we want to override in payline
     *
     * @return $this
     */
     ...
     * Sets costCentre
     *
     * @param string|null $costCentre CostCentre code which we want to override in payline
     *
     * @return $this
     */
     ...
     * Sets costCentreId
     *
     * @param string|null $costCentreId CostCentre uniqueId which we want to override in payline
     *
     * @return $this
     */
     ...
     *
     * @param \SynergiTech\Staffology\Model\ContractPaylineAnalysisCategoriesCodes[]|null $analysisCategoriesCodes List of analysiscategory id and analysiscategoryCode id
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $analysisCategoryCodeIds Array of analysiscategoryCode uniqueId
     *
     * @return $this
     */
