...
/**
 * ContractSpinalPointResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractSpinalPointResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.SpinalPointResponse';
    ...
    protected static array $attributeMap = [
        'id' => 'id',
        'finalAnnualValue' => 'finalAnnualValue',
        'name' => 'name',
        'number' => 'number',
    ...
    protected static array $setters = [
        'id' => 'setId',
        'finalAnnualValue' => 'setFinalAnnualValue',
        'name' => 'setName',
        'number' => 'setNumber',
    ...
    protected static array $getters = [
        'id' => 'getId',
        'finalAnnualValue' => 'getFinalAnnualValue',
        'name' => 'getName',
        'number' => 'getNumber',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('finalAnnualValue', $data ?? [], null);
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Spinal Point identifier
     *
     * @return $this
     */
     ...
     * @return float|null
     */
    public function getFinalAnnualValue(): ?float
    {
        return $this->container['finalAnnualValue'];
    }

    /**
     * Sets finalAnnualValue
     *
     * @param float|null $finalAnnualValue Spinal Point Final Annual Value
     *
     * @return $this
     */
    public function setFinalAnnualValue(?float $finalAnnualValue): static
    {
        if (is_null($finalAnnualValue)) {
            throw new InvalidArgumentException('non-nullable finalAnnualValue cannot be null');
        }
        $this->container['finalAnnualValue'] = $finalAnnualValue;
