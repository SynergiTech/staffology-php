...
/**
 * AeAssessmentAction Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class AeAssessmentAction implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AeAssessmentAction';
    ...
    */
     ...
     *
     * @param bool|null $actionCompleted [readonly] Indicates whether or not the required action was successfully completed
     *
     * @return $this
     */
     ...
     *
     * @param string|null $actionCompletedMessage [readonly] Gives further information about the action taken or the reason if wasn't successfully completed
     *
     * @return $this
     */
     ...
     *
     * @param string|null $pensionSchemeId [readonly] The PensionSchemeId that a completed action relates to
     *
     * @return $this
     */
     ...
     * Sets workerGroupId
     *
     * @param string|null $workerGroupId [readonly] The WorkerGroupId that a completed action relates to
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $letterNotYetSent [readonly] Indicates whether or not any required letter has been sent
     *
     * @return $this
     */
