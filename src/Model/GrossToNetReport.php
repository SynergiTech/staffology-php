...
/**
 * GrossToNetReport Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class GrossToNetReport implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GrossToNetReport';
    ...
    protected static array $openAPITypes = [
        'forCis' => 'bool',
        'lines' => '\SynergiTech\Staffology\Model\GrossToNetReportLine[]',
        'cisLines' => '\SynergiTech\Staffology\Model\GrossToNetReportCisLine[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('cisLines', $data ?? [], null);
    ...
    */
     ...
     * Sets lines
     *
     * @param \SynergiTech\Staffology\Model\GrossToNetReportLine[]|null $lines lines
     *
     * @return $this
     */
     ...
     * Gets cisLines
     *
     * @return \SynergiTech\Staffology\Model\GrossToNetReportCisLine[]|null
     */
    public function getCisLines(): ?array
    {
        return $this->container['cisLines'];
    }

    /**
     * Sets cisLines
     *
     * @param \SynergiTech\Staffology\Model\GrossToNetReportCisLine[]|null $cisLines cisLines
     *
     * @return $this
     */
    public function setCisLines(?array $cisLines): static
    {
        if (is_null($cisLines)) {
            array_push($this->openAPINullablesSetToNull, 'cisLines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('cisLines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['cisLines'] = $cisLines;
