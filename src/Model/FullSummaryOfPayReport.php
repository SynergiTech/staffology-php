...
/**
 * FullSummaryOfPayReport Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class FullSummaryOfPayReport implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'FullSummaryOfPayReport';
    ...
    protected static array $openAPITypes = [
        'lines' => '\SynergiTech\Staffology\Model\FullSummaryOfPayReportLine[]',
        'deductionLines' => '\SynergiTech\Staffology\Model\FullSummaryOfPayReportLine[]',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('deductionLines', $data ?? [], null);
    ...
    */
     ...
     * Gets lines
     *
     * @return \SynergiTech\Staffology\Model\FullSummaryOfPayReportLine[]|null
     */
     ...
     * Sets lines
     *
     * @param \SynergiTech\Staffology\Model\FullSummaryOfPayReportLine[]|null $lines lines
     *
     * @return $this
     */
    ...
    {
        return $this->container['deductionLines'];
    }

    /**
     * Sets deductionLines
     *
     * @param \SynergiTech\Staffology\Model\FullSummaryOfPayReportLine[]|null $deductionLines deductionLines
     *
     * @return $this
     */
    public function setDeductionLines(?array $deductionLines): static
    {
        if (is_null($deductionLines)) {
            array_push($this->openAPINullablesSetToNull, 'deductionLines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('deductionLines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
