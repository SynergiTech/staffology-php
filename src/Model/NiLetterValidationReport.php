...
/**
 * NiLetterValidationReport Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class NiLetterValidationReport implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'NiLetterValidationReport';
    ...
    protected static array $setters = [
        'basedOnPayrun' => 'setBasedOnPayrun',
        'errorLines' => 'setErrorLines',
    ...
    protected static array $getters = [
        'basedOnPayrun' => 'getBasedOnPayrun',
    ...
    {
        $this->setIfExists('basedOnPayrun', $data ?? [], null);
        $this->setIfExists('errorLines', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getBasedOnPayrun(): ?bool
    {
        return $this->container['basedOnPayrun'];
    }

    /**
     * Sets basedOnPayrun
     *
     * @param bool|null $basedOnPayrun If false, then any payrun related information (Tax year, etc) should be ignored.
     *
     * @return $this
     */
    public function setBasedOnPayrun(?bool $basedOnPayrun): static
    {
        if (is_null($basedOnPayrun)) {
            throw new InvalidArgumentException('non-nullable basedOnPayrun cannot be null');
        }
        $this->container['basedOnPayrun'] = $basedOnPayrun;
     ...
     * Gets errorLines
     *
     * @return \SynergiTech\Staffology\Model\NiLetterValidationReportLine[]|null
     */
    public function getErrorLines(): ?array
    {
        return $this->container['errorLines'];
    }

    /**
     * Sets errorLines
     *
     * @param \SynergiTech\Staffology\Model\NiLetterValidationReportLine[]|null $errorLines errorLines
     *
     * @return $this
     */
    public function setErrorLines(?array $errorLines): static
    {
        if (is_null($errorLines)) {
            array_push($this->openAPINullablesSetToNull, 'errorLines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('errorLines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['errorLines'] = $errorLines;
