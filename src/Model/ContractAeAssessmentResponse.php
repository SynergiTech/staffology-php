...
/**
 * ContractAeAssessmentResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractAeAssessmentResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.AeAssessmentResponse';
    ...
    protected static array $openAPITypes = [
        ...
        'reason' => 'string',
        'action' => '\SynergiTech\Staffology\Model\ContractAeAssessmentAction',
        'employee' => '\SynergiTech\Staffology\Model\ContractEmployeeItem',
    ...
    */
     ...
     * Sets age
     *
     * @param int|null $age The age of the Employee at the time of the assessment
     *
     * @return $this
     */
     ...
     * Sets ordinal
     *
     * @param int|null $ordinal The PaySchedule ordinal for the Employee at the time of the assessment
     *
     * @return $this
     */
     ...
     *
     * @param float|null $earningsInPeriod earningsInPeriod
     *
     * @return $this
     */
     ...
     *
     * @param float|null $qualifyingEarningsInPeriod qualifyingEarningsInPeriod
     *
     * @return $this
     */
     ...
     * Sets reason
     *
     * @param string|null $reason The reason for determining the Status given.
     *
     * @return $this
     */
     ...
     * Gets action
     *
     * @return \SynergiTech\Staffology\Model\ContractAeAssessmentAction|null
     */
    public function getAction(): ?\SynergiTech\Staffology\Model\ContractAeAssessmentAction
    {
     ...
     * Sets action
     *
     * @param \SynergiTech\Staffology\Model\ContractAeAssessmentAction|null $action action
     *
     * @return $this
     */
    public function setAction(?\SynergiTech\Staffology\Model\ContractAeAssessmentAction $action): static
    {
        if (is_null($action)) {
     ...
     * Gets employee
     *
     * @return \SynergiTech\Staffology\Model\ContractEmployeeItem|null
     */
    public function getEmployee(): ?\SynergiTech\Staffology\Model\ContractEmployeeItem
    {
     ...
     * Sets employee
     *
     * @param \SynergiTech\Staffology\Model\ContractEmployeeItem|null $employee employee
     *
     * @return $this
     */
    public function setEmployee(?\SynergiTech\Staffology\Model\ContractEmployeeItem $employee): static
    {
        if (is_null($employee)) {
