 ...
 */
class HmrcDetails implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HmrcDetails';
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['officeNumber']) && (mb_strlen($this->container['officeNumber']) > 3)) {
            $invalidProperties[] = "invalid value for 'officeNumber', the character length must be smaller than or equal to 3.";
        }

        if (!is_null($this->container['payeReference']) && (mb_strlen($this->container['payeReference']) > 20)) {
            $invalidProperties[] = "invalid value for 'payeReference', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['accountsOfficeReference']) && (mb_strlen($this->container['accountsOfficeReference']) > 20)) {
            $invalidProperties[] = "invalid value for 'accountsOfficeReference', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['econ']) && (mb_strlen($this->container['econ']) > 20)) {
            $invalidProperties[] = "invalid value for 'econ', the character length must be smaller than or equal to 20.";
        }
        ...
        if (!is_null($this->container['coTax']) && (mb_strlen($this->container['coTax']) > 20)) {
            $invalidProperties[] = "invalid value for 'coTax', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setOfficeNumber(?string $officeNumber): static
    {
        ...
        if (!is_null($officeNumber) && (mb_strlen($officeNumber) > 3)) {
            throw new InvalidArgumentException('invalid length for $officeNumber when calling HmrcDetails., must be smaller than or equal to 3.');
        }
    ...
    public function setPayeReference(?string $payeReference): static
    {
        ...
        if (!is_null($payeReference) && (mb_strlen($payeReference) > 20)) {
            throw new InvalidArgumentException('invalid length for $payeReference when calling HmrcDetails., must be smaller than or equal to 20.');
        }
    ...
    public function setAccountsOfficeReference(?string $accountsOfficeReference): static
    {
        ...
        if (!is_null($accountsOfficeReference) && (mb_strlen($accountsOfficeReference) > 20)) {
            throw new InvalidArgumentException('invalid length for $accountsOfficeReference when calling HmrcDetails., must be smaller than or equal to 20.');
        }
    ...
    public function setEcon(?string $econ): static
    {
        ...
        if (!is_null($econ) && (mb_strlen($econ) > 20)) {
            throw new InvalidArgumentException('invalid length for $econ when calling HmrcDetails., must be smaller than or equal to 20.');
        }
    ...
    public function setUtr(?string $utr): static
    {
        ...
        if (!is_null($utr) && (mb_strlen($utr) > 20)) {
            throw new InvalidArgumentException('invalid length for $utr when calling HmrcDetails., must be smaller than or equal to 20.');
        }
    ...
    public function setCoTax(?string $coTax): static
    {
        ...
        if (!is_null($coTax) && (mb_strlen($coTax) > 20)) {
            throw new InvalidArgumentException('invalid length for $coTax when calling HmrcDetails., must be smaller than or equal to 20.');
        }
