...
/**
 * PensionAdministrator Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PensionAdministrator implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PensionAdministrator';
    ...
    */
    ...
    public function setName(?string $name): static
    {
        ...
        if (!is_null($name) && (mb_strlen($name) > 150)) {
            throw new InvalidArgumentException('invalid length for $name when calling PensionAdministrator., must be smaller than or equal to 150.');
        }
    ...
    public function setEmail(?string $email): static
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 150)) {
            throw new InvalidArgumentException('invalid length for $email when calling PensionAdministrator., must be smaller than or equal to 150.');
        }
    ...
    public function setTelephone(?string $telephone): static
    {
        ...
        if (!is_null($telephone) && (mb_strlen($telephone) > 100)) {
            throw new InvalidArgumentException('invalid length for $telephone when calling PensionAdministrator., must be smaller than or equal to 100.');
        }
