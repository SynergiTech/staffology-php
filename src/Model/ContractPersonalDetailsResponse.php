...
/**
 * ContractPersonalDetailsResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractPersonalDetailsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.PersonalDetailsResponse';
    ...
    */
     ...
     *
     * @param int|null $statePensionAge Automatically calculated.
     *
     * @return $this
     */
    ...
    public function setTitle(?string $title): static
    {
        ...
        if (!is_null($title) && (mb_strlen($title) > 30)) {
            throw new InvalidArgumentException('invalid length for $title when calling ContractPersonalDetailsResponse., must be smaller than or equal to 30.');
        }
    ...
    public function setFirstName(?string $firstName): static
    {
        ...
        if (!is_null($firstName) && (mb_strlen($firstName) > 35)) {
            throw new InvalidArgumentException('invalid length for $firstName when calling ContractPersonalDetailsResponse., must be smaller than or equal to 35.');
        }
    ...
    public function setMiddleName(?string $middleName): static
    {
        ...
        if (!is_null($middleName) && (mb_strlen($middleName) > 35)) {
            throw new InvalidArgumentException('invalid length for $middleName when calling ContractPersonalDetailsResponse., must be smaller than or equal to 35.');
        }
    ...
    public function setLastName(?string $lastName): static
    {
        ...
        if (!is_null($lastName) && (mb_strlen($lastName) > 35)) {
            throw new InvalidArgumentException('invalid length for $lastName when calling ContractPersonalDetailsResponse., must be smaller than or equal to 35.');
        }
    ...
    public function setAlternativeEmail(?string $alternativeEmail): static
    {
        ...
        if (!is_null($alternativeEmail) && (mb_strlen($alternativeEmail) > 100)) {
            throw new InvalidArgumentException('invalid length for $alternativeEmail when calling ContractPersonalDetailsResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setPreviousSurName(?string $previousSurName): static
    {
        ...
        if (!is_null($previousSurName) && (mb_strlen($previousSurName) > 35)) {
            throw new InvalidArgumentException('invalid length for $previousSurName when calling ContractPersonalDetailsResponse., must be smaller than or equal to 35.');
        }
    ...
    public function setEmail(?string $email): static
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 100)) {
            throw new InvalidArgumentException('invalid length for $email when calling ContractPersonalDetailsResponse., must be smaller than or equal to 100.');
        }
    ...
    public function setPhotoUrl(?string $photoUrl): static
    {
        ...
        if (!is_null($photoUrl) && (mb_strlen($photoUrl) > 250)) {
            throw new InvalidArgumentException('invalid length for $photoUrl when calling ContractPersonalDetailsResponse., must be smaller than or equal to 250.');
        }
    ...
    public function setTelephone(?string $telephone): static
    {
        ...
        if (!is_null($telephone) && (mb_strlen($telephone) > 30)) {
            throw new InvalidArgumentException('invalid length for $telephone when calling ContractPersonalDetailsResponse., must be smaller than or equal to 30.');
        }
    ...
    public function setMobile(?string $mobile): static
    {
        ...
        if (!is_null($mobile) && (mb_strlen($mobile) > 30)) {
            throw new InvalidArgumentException('invalid length for $mobile when calling ContractPersonalDetailsResponse., must be smaller than or equal to 30.');
        }
    ...
    public function setNiNumber(?string $niNumber): static
    {
        ...
        if (!is_null($niNumber) && (mb_strlen($niNumber) > 15)) {
            throw new InvalidArgumentException('invalid length for $niNumber when calling ContractPersonalDetailsResponse., must be smaller than or equal to 15.');
        }
    ...
    public function setPassportNumber(?string $passportNumber): static
    {
        ...
        if (!is_null($passportNumber) && (mb_strlen($passportNumber) > 25)) {
            throw new InvalidArgumentException('invalid length for $passportNumber when calling ContractPersonalDetailsResponse., must be smaller than or equal to 25.');
        }
     ...
     * Gets partnerDetails
     *
     * @return \SynergiTech\Staffology\Model\ContractPartnerDetails|null
     */
    public function getPartnerDetails(): ?\SynergiTech\Staffology\Model\ContractPartnerDetails
    {
     ...
     * Sets partnerDetails
     *
     * @param \SynergiTech\Staffology\Model\ContractPartnerDetails|null $partnerDetails partnerDetails
     *
     * @return $this
     */
    public function setPartnerDetails(?\SynergiTech\Staffology\Model\ContractPartnerDetails $partnerDetails): static
    {
