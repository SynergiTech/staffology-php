...
/**
 * PayrollAnalysisCostBreakdownReport Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PayrollAnalysisCostBreakdownReport implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PayrollAnalysisCostBreakdownReport';
    ...
    protected static array $openAPITypes = [
        'lines' => '\SynergiTech\Staffology\Model\PayrollAnalysisCostBreakdownReportLine[]',
        'payCodes' => '\SynergiTech\Staffology\Model\PayCode[]',
        'employeesPayRunTotals' => '\SynergiTech\Staffology\Model\EmployeePayRunTotal[]',
    ...
    protected static array $attributeMap = [
        'lines' => 'lines',
        'payCodes' => 'payCodes',
        'employeesPayRunTotals' => 'employeesPayRunTotals',
        'employer' => 'employer',
        'payPeriod' => 'payPeriod',
        'ordinal' => 'ordinal',
        'period' => 'period',
    ...
    protected static array $setters = [
        ...
        'employeesPayRunTotals' => 'setEmployeesPayRunTotals',
    ...
    protected static array $getters = [
        ...
        'employeesPayRunTotals' => 'getEmployeesPayRunTotals',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('employeesPayRunTotals', $data ?? [], null);
    ...
    */
     ...
     * Gets lines
     *
     * @return \SynergiTech\Staffology\Model\PayrollAnalysisCostBreakdownReportLine[]|null
     */
     ...
     * Sets lines
     *
     * @param \SynergiTech\Staffology\Model\PayrollAnalysisCostBreakdownReportLine[]|null $lines lines
     *
     * @return $this
     */
    ...
    /**
     * Gets employeesPayRunTotals
     *
     * @return \SynergiTech\Staffology\Model\EmployeePayRunTotal[]|null
     */
    public function getEmployeesPayRunTotals(): ?array
    {
        return $this->container['employeesPayRunTotals'];
    }

    /**
     * Sets employeesPayRunTotals
     *
     * @param \SynergiTech\Staffology\Model\EmployeePayRunTotal[]|null $employeesPayRunTotals employeesPayRunTotals
     *
     * @return $this
     */
    public function setEmployeesPayRunTotals(?array $employeesPayRunTotals): static
    {
        if (is_null($employeesPayRunTotals)) {
            array_push($this->openAPINullablesSetToNull, 'employeesPayRunTotals');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('employeesPayRunTotals', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['employeesPayRunTotals'] = $employeesPayRunTotals;
