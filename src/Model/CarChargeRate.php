...
/**
 * CarChargeRate Class Doc Comment
 *
 ...
 */
class CarChargeRate implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CarChargeRate';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('rangeStop', $data ?? [], null);
    ...
    */
     ...
     * @return int|null
     */
    public function getRangeStop(): ?int
    {
        return $this->container['rangeStop'];
    }

    /**
     * Sets rangeStop
     *
     * @param int|null $rangeStop rangeStop
     *
     * @return $this
     */
    public function setRangeStop(?int $rangeStop): static
    {
        if (is_null($rangeStop)) {
            throw new InvalidArgumentException('non-nullable rangeStop cannot be null');
        }
        $this->container['rangeStop'] = $rangeStop;
