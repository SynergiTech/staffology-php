...
/**
 * HolidayReportLine Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class HolidayReportLine implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HolidayReportLine';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('dayRate', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['dayRate'];
    }

    /**
     * Sets dayRate
     *
     * @param float|null $dayRate dayRate
     *
     * @return $this
     */
    ...
    {
        if (is_null($dayRate)) {
            array_push($this->openAPINullablesSetToNull, 'dayRate');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('dayRate', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['dayRate'] = $dayRate;
