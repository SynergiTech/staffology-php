...
/**
 * NominalCodeMapping Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class NominalCodeMapping implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'NominalCodeMapping';
    ...
    protected static array $setters = [
        ...
        'payCode' => 'setPayCode',
        'nominalMapping' => 'setNominalMapping',
        'id' => 'setId'
    ];
    ...
    protected static array $getters = [
        ...
        'payCode' => 'getPayCode',
        'nominalMapping' => 'getNominalMapping',
        'id' => 'getId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('nominalMapping', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['nominalMapping']) && (mb_strlen($this->container['nominalMapping']) > 500)) {
            $invalidProperties[] = "invalid value for 'nominalMapping', the character length must be smaller than or equal to 500.";
        }
     ...
     * Sets nominalCode
     *
     * @param string|null $nominalCode nominalCode
     *
     * @return $this
     */
    public function setNominalCode(?string $nominalCode): static
    {
        ...
        if (!is_null($nominalCode) && (mb_strlen($nominalCode) > 500)) {
            throw new InvalidArgumentException('invalid length for $nominalCode when calling NominalCodeMapping., must be smaller than or equal to 500.');
        }
     ...
     * Sets nominalName
     *
     * @param string|null $nominalName nominalName
     *
     * @return $this
     */
    public function setNominalName(?string $nominalName): static
    {
        ...
        if (!is_null($nominalName) && (mb_strlen($nominalName) > 100)) {
            throw new InvalidArgumentException('invalid length for $nominalName when calling NominalCodeMapping., must be smaller than or equal to 100.');
        }
     ...
     * Sets externalId
     *
     * @param string|null $externalId If you will be using the API to post journals to an ExternalDataProvider, then this is the Id of the nominal code in the external system.  If there's no mapping then this will have a value of \"0\"
     *
     * @return $this
     */
    public function setExternalId(?string $externalId): static
    {
        ...
        if (!is_null($externalId) && (mb_strlen($externalId) > 100)) {
            throw new InvalidArgumentException('invalid length for $externalId when calling NominalCodeMapping., must be smaller than or equal to 100.');
        }
     ...
     * @return string|null
     */
    public function getNominalMapping(): ?string
    {
        return $this->container['nominalMapping'];
    }

    /**
     * Sets nominalMapping
     *
     * @param string|null $nominalMapping nominalMapping
     *
     * @return $this
     */
    public function setNominalMapping(?string $nominalMapping): static
    {
        if (is_null($nominalMapping)) {
            array_push($this->openAPINullablesSetToNull, 'nominalMapping');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('nominalMapping', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        if (!is_null($nominalMapping) && (mb_strlen($nominalMapping) > 500)) {
            throw new InvalidArgumentException('invalid length for $nominalMapping when calling NominalCodeMapping., must be smaller than or equal to 500.');
        }

        $this->container['nominalMapping'] = $nominalMapping;
