 ...
 */
class PayOptions implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PayOptions';
    ...
    protected static array $openAPITypes = [
        ...
        'taxAndNi' => '\SynergiTech\Staffology\Model\TaxAndNi',
        'fpsFields' => '\SynergiTech\Staffology\Model\FpsFields',
        'tags' => 'string[]',
        ...
        'niTable' => 'string',
        'regularPayLines' => '\SynergiTech\Staffology\Model\PayLine[]',
        'excludedRegularPayLines' => '\SynergiTech\Staffology\Model\PayLine[]'
    ];
    ...
    protected static array $attributeMap = [
        ...
        'excludedRegularPayLines' => 'excludedRegularPayLines'
    ];
    ...
    protected static array $setters = [
        ...
        'excludedRegularPayLines' => 'setExcludedRegularPayLines'
    ];
    ...
    protected static array $getters = [
        ...
        'excludedRegularPayLines' => 'getExcludedRegularPayLines'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('excludedRegularPayLines', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets taxAndNi
     *
     * @return \SynergiTech\Staffology\Model\TaxAndNi|null
     */
    public function getTaxAndNi(): ?\SynergiTech\Staffology\Model\TaxAndNi
    {
     ...
     * Sets taxAndNi
     *
     * @param \SynergiTech\Staffology\Model\TaxAndNi|null $taxAndNi taxAndNi
     *
     * @return $this
     */
    public function setTaxAndNi(?\SynergiTech\Staffology\Model\TaxAndNi $taxAndNi): static
    {
        if (is_null($taxAndNi)) {
     ...
     * Gets fpsFields
     *
     * @return \SynergiTech\Staffology\Model\FpsFields|null
     */
    public function getFpsFields(): ?\SynergiTech\Staffology\Model\FpsFields
    {
     ...
     * Sets fpsFields
     *
     * @param \SynergiTech\Staffology\Model\FpsFields|null $fpsFields fpsFields
     *
     * @return $this
     */
    public function setFpsFields(?\SynergiTech\Staffology\Model\FpsFields $fpsFields): static
    {
     ...
     * Sets basicPay
     *
     * @param float|null $basicPay The amount of basic pay the Employee is regularly paid each period  This amount is the combined total of all pay elements that contribute to basic pay
     *
     * @return $this
     */
     ...
     *
     * @param \SynergiTech\Staffology\Model\PayLine[]|null $regularPayLines These are used to make additions/deductions to the pay for this Employee.  You do not need to include Pension, Tax, NI,  Loan Repayments, etc as these will all be automatically created.
     *
     * @return $this
     */
    ...
    /**
     * Gets excludedRegularPayLines
     *
     * @return \SynergiTech\Staffology\Model\PayLine[]|null
     */
    public function getExcludedRegularPayLines(): ?array
    {
        return $this->container['excludedRegularPayLines'];
    }

    /**
     * Sets excludedRegularPayLines
     *
     * @param \SynergiTech\Staffology\Model\PayLine[]|null $excludedRegularPayLines These used to store the PayLines that have been excluded from RegularPaylines.
     *
     * @return $this
     */
    public function setExcludedRegularPayLines(?array $excludedRegularPayLines): static
    {
        if (is_null($excludedRegularPayLines)) {
            array_push($this->openAPINullablesSetToNull, 'excludedRegularPayLines');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('excludedRegularPayLines', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['excludedRegularPayLines'] = $excludedRegularPayLines;
