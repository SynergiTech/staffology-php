...
class OpeningBalances implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'OpeningBalances';
    ...
    protected static array $setters = [
        'notNewStarter' => 'setNotNewStarter',
        'taxYear' => 'setTaxYear',
    ...
    protected static array $getters = [
        'notNewStarter' => 'getNotNewStarter',
        'taxYear' => 'getTaxYear',
    ...
    {
        $this->setIfExists('notNewStarter', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getNotNewStarter(): ?bool
    {
        return $this->container['notNewStarter'];
    }

    /**
     * Sets notNewStarter
     *
     * @param bool|null $notNewStarter notNewStarter
     *
     * @return $this
     */
    public function setNotNewStarter(?bool $notNewStarter): static
    {
        if (is_null($notNewStarter)) {
            throw new InvalidArgumentException('non-nullable notNewStarter cannot be null');
        }
        $this->container['notNewStarter'] = $notNewStarter;
