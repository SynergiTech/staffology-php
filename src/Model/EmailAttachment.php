...
class EmailAttachment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EmailAttachment';
    ...
    */
    ...
    public function setUrl(string $url): static
    {
        ...
        if ((mb_strlen($url) < 1)) {
            throw new InvalidArgumentException('invalid length for $url when calling EmailAttachment., must be bigger than or equal to 1.');
        }
