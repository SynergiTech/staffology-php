...
/**
 * EmployeeCostCentre Class Doc Comment
 *
 ...
 */
class EmployeeCostCentre implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EmployeeCostCentre';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code The Code for the Cost Centre
     *
     * @return $this
     */
    public function setCode(string $code): static
    {
        ...
        if ((mb_strlen($code) < 1)) {
            throw new InvalidArgumentException('invalid length for $code when calling EmployeeCostCentre., must be bigger than or equal to 1.');
        }
     ...
     * Sets color
     *
     * @param string|null $color [readonly] The Color for the Cost Centre
     *
     * @return $this
     */
     ...
     * Sets title
     *
     * @param string|null $title [readonly] The Title for the Cost Centre
     *
     * @return $this
     */
     ...
     * Sets isPrimary
     *
     * @param bool|null $isPrimary Set to true if this is the primary Cost Centre for the Employee.  Only one Cost Centre can be set as the primary.
     *
     * @return $this
     */
     ...
     * Sets weighting
     *
     * @param float|null $weighting If there is more than one Cost Centre Membership for the Employee then this determines the weighting to give to this membership.  ie, if he is in two Cost Centre you might set the primary as 0.8 and the secondary as 0.2;
     *
     * @return $this
     */
