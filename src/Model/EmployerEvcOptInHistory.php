...
/**
 * EmployerEvcOptInHistory Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class EmployerEvcOptInHistory implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EmployerEvcOptInHistory';
    ...
    {
        $this->setIfExists('optIn', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($optIn)) {
            throw new InvalidArgumentException('non-nullable optIn cannot be null');
        }
