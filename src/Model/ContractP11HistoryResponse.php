...
/**
 * ContractP11HistoryResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractP11HistoryResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.P11HistoryResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('payDate', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets payDate
     *
     * @param \DateTime|null $payDate payDate
     *
     * @return $this
     */
    public function setPayDate(?\DateTime $payDate): static
    {
        if (is_null($payDate)) {
            throw new InvalidArgumentException('non-nullable payDate cannot be null');
        }
