...
/**
 * CisVerification Class Doc Comment
 *
 ...
 */
class CisVerification implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CisVerification';
    ...
    protected static array $openAPITypes = [
        ...
        'employeeCount' => 'int',
        'cisRequest' => '\SynergiTech\Staffology\Model\CisRequest',
        'responses' => '\SynergiTech\Staffology\Model\CisSubContractor[]',
        'iRmark' => 'string',
        'xml' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('cisRequest', $data ?? [], null);
    ...
    */
     ...
     * Gets cisRequest
     *
     * @return \SynergiTech\Staffology\Model\CisRequest|null
     */
    public function getCisRequest(): ?\SynergiTech\Staffology\Model\CisRequest
    {
        return $this->container['cisRequest'];
    }

    /**
     * Sets cisRequest
     *
     * @param \SynergiTech\Staffology\Model\CisRequest|null $cisRequest cisRequest
     *
     * @return $this
     */
    public function setCisRequest(?\SynergiTech\Staffology\Model\CisRequest $cisRequest): static
    {
        if (is_null($cisRequest)) {
            throw new InvalidArgumentException('non-nullable cisRequest cannot be null');
        }
        $this->container['cisRequest'] = $cisRequest;
     ...
     * Sets responses
     *
     * @param \SynergiTech\Staffology\Model\CisSubContractor[]|null $responses responses
     *
     * @return $this
     */
