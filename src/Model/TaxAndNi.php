 ...
 */
class TaxAndNi implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TaxAndNi';
    ...
    */
    ...
    public function setTaxCode(?string $taxCode): static
    {
        ...
        if (!is_null($taxCode) && (mb_strlen($taxCode) > 12)) {
            throw new InvalidArgumentException('invalid length for $taxCode when calling TaxAndNi., must be smaller than or equal to 12.');
        }
