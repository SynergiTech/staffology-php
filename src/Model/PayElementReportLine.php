...
/**
 * PayElementReportLine Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class PayElementReportLine implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PayElementReportLine';
    ...
    protected static array $openAPITypes = [
        ...
        'payrollCode' => 'string',
        'niNumber' => 'string',
        'payElements' => 'array<string,float>',
        'hasPay' => 'bool',
        'totalPay' => 'float'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('payElements', $data ?? [], null);
        $this->setIfExists('hasPay', $data ?? [], null);
    ...
    */
     ...
     */
    public function getPayElements(): ?array
    {
        return $this->container['payElements'];
    }

    /**
     * Sets payElements
     *
     * @param array<string,float>|null $payElements payElements
     *
     * @return $this
     */
    public function setPayElements(?array $payElements): static
    {
        if (is_null($payElements)) {
            array_push($this->openAPINullablesSetToNull, 'payElements');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('payElements', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['payElements'] = $payElements;
     ...
     * @return bool|null
     */
    public function getHasPay(): ?bool
    {
        return $this->container['hasPay'];
    }

    /**
     * Sets hasPay
     *
     * @param bool|null $hasPay hasPay
     *
     * @return $this
     */
    public function setHasPay(?bool $hasPay): static
    {
        if (is_null($hasPay)) {
            throw new InvalidArgumentException('non-nullable hasPay cannot be null');
        }
        $this->container['hasPay'] = $hasPay;
