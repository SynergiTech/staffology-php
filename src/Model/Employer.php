...
class Employer implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Employer';
    ...
    protected static array $openAPITypes = [
        ...
        'defaultPayOptions' => '\SynergiTech\Staffology\Model\PayOptions',
        'hmrcDetails' => '\SynergiTech\Staffology\Model\HmrcDetails',
        'defaultPension' => '\SynergiTech\Staffology\Model\PensionSelection',
        'rtiSubmissionSettings' => '\SynergiTech\Staffology\Model\RtiSubmissionSettings',
        'autoEnrolmentSettings' => '\SynergiTech\Staffology\Model\AutoEnrolmentSettings',
        'accruePayCodeSetUniqueId' => 'string',
        'leaveSettings' => '\SynergiTech\Staffology\Model\LeaveSettings',
        'settings' => '\SynergiTech\Staffology\Model\EmployerSettings',
        'umbrellaSettings' => '\SynergiTech\Staffology\Model\UmbrellaSettings',
        'employeeCount' => 'int',
    ...
    */
    ...
    public function listInvalidProperties(): array
    {
        ...
        if (!is_null($this->container['crn']) && (mb_strlen($this->container['crn']) > 25)) {
            $invalidProperties[] = "invalid value for 'crn', the character length must be smaller than or equal to 25.";
        }

        if (!is_null($this->container['logoUrl']) && (mb_strlen($this->container['logoUrl']) > 200)) {
            $invalidProperties[] = "invalid value for 'logoUrl', the character length must be smaller than or equal to 200.";
        }

        if (!is_null($this->container['alternativeId']) && (mb_strlen($this->container['alternativeId']) > 30)) {
            $invalidProperties[] = "invalid value for 'alternativeId', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['bacsServiceUserNumber']) && (mb_strlen($this->container['bacsServiceUserNumber']) > 6)) {
            $invalidProperties[] = "invalid value for 'bacsServiceUserNumber', the character length must be smaller than or equal to 6.";
        }

        if (!is_null($this->container['bacsBureauNumber']) && (mb_strlen($this->container['bacsBureauNumber']) > 20)) {
            $invalidProperties[] = "invalid value for 'bacsBureauNumber', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['bankPaymentsReferenceFormat']) && (mb_strlen($this->container['bankPaymentsReferenceFormat']) > 120)) {
            $invalidProperties[] = "invalid value for 'bankPaymentsReferenceFormat', the character length must be smaller than or equal to 120.";
        }
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) > 200)) {
            throw new InvalidArgumentException('invalid length for $name when calling Employer., must be smaller than or equal to 200.');
        }
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling Employer., must be bigger than or equal to 1.');
        }
    ...
    public function setCrn(?string $crn): static
    {
        ...
        if (!is_null($crn) && (mb_strlen($crn) > 25)) {
            throw new InvalidArgumentException('invalid length for $crn when calling Employer., must be smaller than or equal to 25.');
        }
    ...
    public function setLogoUrl(?string $logoUrl): static
    {
        ...
        if (!is_null($logoUrl) && (mb_strlen($logoUrl) > 200)) {
            throw new InvalidArgumentException('invalid length for $logoUrl when calling Employer., must be smaller than or equal to 200.');
        }
    ...
    public function setAlternativeId(?string $alternativeId): static
    {
        ...
        if (!is_null($alternativeId) && (mb_strlen($alternativeId) > 30)) {
            throw new InvalidArgumentException('invalid length for $alternativeId when calling Employer., must be smaller than or equal to 30.');
        }
    ...
    public function setBacsServiceUserNumber(?string $bacsServiceUserNumber): static
    {
        ...
        if (!is_null($bacsServiceUserNumber) && (mb_strlen($bacsServiceUserNumber) > 6)) {
            throw new InvalidArgumentException('invalid length for $bacsServiceUserNumber when calling Employer., must be smaller than or equal to 6.');
        }
    ...
    public function setBacsBureauNumber(?string $bacsBureauNumber): static
    {
        ...
        if (!is_null($bacsBureauNumber) && (mb_strlen($bacsBureauNumber) > 20)) {
            throw new InvalidArgumentException('invalid length for $bacsBureauNumber when calling Employer., must be smaller than or equal to 20.');
        }
    ...
    public function setBankPaymentsReferenceFormat(?string $bankPaymentsReferenceFormat): static
    {
        ...
        if (!is_null($bankPaymentsReferenceFormat) && (mb_strlen($bankPaymentsReferenceFormat) > 120)) {
            throw new InvalidArgumentException('invalid length for $bankPaymentsReferenceFormat when calling Employer., must be smaller than or equal to 120.');
        }
     ...
     */
    public function getDefaultPayOptions(): ?\SynergiTech\Staffology\Model\PayOptions
    {
     ...
     *
     * @param \SynergiTech\Staffology\Model\PayOptions|null $defaultPayOptions defaultPayOptions
     *
     * @return $this
     */
    public function setDefaultPayOptions(?\SynergiTech\Staffology\Model\PayOptions $defaultPayOptions): static
    {
     ...
     * Gets defaultPension
     *
     * @return \SynergiTech\Staffology\Model\PensionSelection|null
     */
    public function getDefaultPension(): ?\SynergiTech\Staffology\Model\PensionSelection
    {
     ...
     * Sets defaultPension
     *
     * @param \SynergiTech\Staffology\Model\PensionSelection|null $defaultPension defaultPension
     *
     * @return $this
     */
    public function setDefaultPension(?\SynergiTech\Staffology\Model\PensionSelection $defaultPension): static
    {
     ...
     *
     * @return \SynergiTech\Staffology\Model\RtiSubmissionSettings|null
     */
    public function getRtiSubmissionSettings(): ?\SynergiTech\Staffology\Model\RtiSubmissionSettings
    {
     ...
     *
     * @param \SynergiTech\Staffology\Model\RtiSubmissionSettings|null $rtiSubmissionSettings rtiSubmissionSettings
     *
     * @return $this
     */
    public function setRtiSubmissionSettings(?\SynergiTech\Staffology\Model\RtiSubmissionSettings $rtiSubmissionSettings): static
    {
     ...
     *
     * @return \SynergiTech\Staffology\Model\AutoEnrolmentSettings|null
     */
    public function getAutoEnrolmentSettings(): ?\SynergiTech\Staffology\Model\AutoEnrolmentSettings
    {
     ...
     *
     * @param \SynergiTech\Staffology\Model\AutoEnrolmentSettings|null $autoEnrolmentSettings autoEnrolmentSettings
     *
     * @return $this
     */
    public function setAutoEnrolmentSettings(?\SynergiTech\Staffology\Model\AutoEnrolmentSettings $autoEnrolmentSettings): static
    {
     ...
     * Gets leaveSettings
     *
     * @return \SynergiTech\Staffology\Model\LeaveSettings|null
     */
    public function getLeaveSettings(): ?\SynergiTech\Staffology\Model\LeaveSettings
    {
     ...
     * Sets leaveSettings
     *
     * @param \SynergiTech\Staffology\Model\LeaveSettings|null $leaveSettings leaveSettings
     *
     * @return $this
     */
    public function setLeaveSettings(?\SynergiTech\Staffology\Model\LeaveSettings $leaveSettings): static
    {
     ...
     * Gets settings
     *
     * @return \SynergiTech\Staffology\Model\EmployerSettings|null
     */
    public function getSettings(): ?\SynergiTech\Staffology\Model\EmployerSettings
    {
     ...
     * Sets settings
     *
     * @param \SynergiTech\Staffology\Model\EmployerSettings|null $settings settings
     *
     * @return $this
     */
    public function setSettings(?\SynergiTech\Staffology\Model\EmployerSettings $settings): static
    {
        if (is_null($settings)) {
     ...
     *
     * @return \SynergiTech\Staffology\Model\UmbrellaSettings|null
     */
    public function getUmbrellaSettings(): ?\SynergiTech\Staffology\Model\UmbrellaSettings
    {
     ...
     *
     * @param \SynergiTech\Staffology\Model\UmbrellaSettings|null $umbrellaSettings umbrellaSettings
     *
     * @return $this
     */
    public function setUmbrellaSettings(?\SynergiTech\Staffology\Model\UmbrellaSettings $umbrellaSettings): static
    {
    ...
    public function setSourceSystemId(?string $sourceSystemId): static
    {
        ...
        if (!is_null($sourceSystemId) && (mb_strlen($sourceSystemId) > 50)) {
            throw new InvalidArgumentException('invalid length for $sourceSystemId when calling Employer., must be smaller than or equal to 50.');
        }
