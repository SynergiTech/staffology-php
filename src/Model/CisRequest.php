 ...
 */
class CisRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CisRequest';
    ...
    */
     ...
     * Sets declaration
     *
     * @param string|null $declaration declaration
     *
     * @return $this
     */
    public function setDeclaration(?string $declaration): static
    {
        if (is_null($declaration)) {
            array_push($this->openAPINullablesSetToNull, 'declaration');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('declaration', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
