 ...
 */
class PeriodValue implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PeriodValue';
    ...
    protected static array $openAPITypes = [
        ...
        'annualValue' => 'float',
        'periodValues' => '\SynergiTech\Staffology\Model\PeriodValuePeriodValues',
        'midYearChanges' => '\SynergiTech\Staffology\Model\PeriodValue[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('periodValues', $data ?? [], null);
    ...
    */
     ...
     * Sets annualValue
     *
     * @param float|null $annualValue The Annual value
     *
     * @return $this
     */
     ...
     * Gets periodValues
     *
     * @return \SynergiTech\Staffology\Model\PeriodValuePeriodValues|null
     */
    public function getPeriodValues(): ?\SynergiTech\Staffology\Model\PeriodValuePeriodValues
    {
        return $this->container['periodValues'];
    }

    /**
     * Sets periodValues
     *
     * @param \SynergiTech\Staffology\Model\PeriodValuePeriodValues|null $periodValues periodValues
     *
     * @return $this
     */
    public function setPeriodValues(?\SynergiTech\Staffology\Model\PeriodValuePeriodValues $periodValues): static
    {
        if (is_null($periodValues)) {
            array_push($this->openAPINullablesSetToNull, 'periodValues');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('periodValues', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['periodValues'] = $periodValues;
     ...
     * Sets midYearChanges
     *
     * @param \SynergiTech\Staffology\Model\PeriodValue[]|null $midYearChanges Any optional changes to the period values that are effective from a specified date in the middle of a tax year
     *
     * @return $this
     */
