...
/**
 * ContractHolidaySchemeResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractHolidaySchemeResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.HolidaySchemeResponse';
    ...
    */
     ...
     * Sets id
     *
     * @param string|null $id Holiday scheme identifier
     *
     * @return $this
     */
    ...
    public function setName(string $name): static
    {
        ...
        if ((mb_strlen($name) < 1)) {
            throw new InvalidArgumentException('invalid length for $name when calling ContractHolidaySchemeResponse., must be bigger than or equal to 1.');
        }
