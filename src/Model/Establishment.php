 ...
 */
class Establishment implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Establishment';
    ...
    protected static array $setters = [
        ...
        'establishmentCode' => 'setEstablishmentCode',
        'id' => 'setId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('establishmentCode', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $localAuthorityNumber localAuthorityNumber
     *
     * @return $this
     */
     ...
     *
     * @param string|null $schoolEmployerType schoolEmployerType
     *
     * @return $this
     */
    ...
    /**
     * Gets establishmentCode
     *
     * @return string|null
     */
    public function getEstablishmentCode(): ?string
    {
        return $this->container['establishmentCode'];
    }

    /**
     * Sets establishmentCode
     *
     * @param string|null $establishmentCode establishmentCode
     *
     * @return $this
     */
    public function setEstablishmentCode(?string $establishmentCode): static
    {
        if (is_null($establishmentCode)) {
            array_push($this->openAPINullablesSetToNull, 'establishmentCode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('establishmentCode', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['establishmentCode'] = $establishmentCode;
