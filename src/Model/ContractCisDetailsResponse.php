...
/**
 * ContractCisDetailsResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractCisDetailsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.CisDetailsResponse';
    ...
    protected static array $openAPITypes = [
        'verification' => '\SynergiTech\Staffology\Model\ContractCisVerificationDetailsResponse',
    ...
    */
     ...
     * Gets verification
     *
     * @return \SynergiTech\Staffology\Model\ContractCisVerificationDetailsResponse|null
     */
    public function getVerification(): ?\SynergiTech\Staffology\Model\ContractCisVerificationDetailsResponse
    {
     ...
     * Sets verification
     *
     * @param \SynergiTech\Staffology\Model\ContractCisVerificationDetailsResponse|null $verification verification
     *
     * @return $this
     */
    public function setVerification(?\SynergiTech\Staffology\Model\ContractCisVerificationDetailsResponse $verification): static
    {
    ...
    public function setUtr(?string $utr): static
    {
        ...
        if (!is_null($utr) && (mb_strlen($utr) > 20)) {
            throw new InvalidArgumentException('invalid length for $utr when calling ContractCisDetailsResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setTradingName(?string $tradingName): static
    {
        ...
        if (!is_null($tradingName) && (mb_strlen($tradingName) > 200)) {
            throw new InvalidArgumentException('invalid length for $tradingName when calling ContractCisDetailsResponse., must be smaller than or equal to 200.');
        }
    ...
    public function setCompanyUtr(?string $companyUtr): static
    {
        ...
        if (!is_null($companyUtr) && (mb_strlen($companyUtr) > 20)) {
            throw new InvalidArgumentException('invalid length for $companyUtr when calling ContractCisDetailsResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setCompanyNumber(?string $companyNumber): static
    {
        ...
        if (!is_null($companyNumber) && (mb_strlen($companyNumber) > 20)) {
            throw new InvalidArgumentException('invalid length for $companyNumber when calling ContractCisDetailsResponse., must be smaller than or equal to 20.');
        }
    ...
    public function setVatNumber(?string $vatNumber): static
    {
        ...
        if (!is_null($vatNumber) && (mb_strlen($vatNumber) > 20)) {
            throw new InvalidArgumentException('invalid length for $vatNumber when calling ContractCisDetailsResponse., must be smaller than or equal to 20.');
        }
