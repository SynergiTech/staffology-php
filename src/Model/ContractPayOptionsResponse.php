...
/**
 * ContractPayOptionsResponse Class Doc Comment
 *
 * @package  SynergiTech\Staffology
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ContractPayOptionsResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Contract.PayOptionsResponse';
    ...
    protected static array $openAPITypes = [
        'regularPayLines' => '\SynergiTech\Staffology\Model\ContractPayLineResponse[]',
        'basicPay' => 'float',
    ...
    */
     ...
     *
     * @return \SynergiTech\Staffology\Model\ContractPayLineResponse[]|null
     */
     ...
     *
     * @param \SynergiTech\Staffology\Model\ContractPayLineResponse[]|null $regularPayLines These are used to make additions/deductions to the pay for this Employee.  You do not need to include Pension, Tax, NI,  Loan Repayments, etc as these will all be automatically created.
     *
     * @return $this
     */
