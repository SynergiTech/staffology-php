...
**model** | [**\SynergiTech\Staffology\Model\CisStatement[]**](CisStatement.md) | [readonly] If the type is application.json then this will contain a JSON representation of the relevant model | [optional]
