...
**model** | [**\SynergiTech\Staffology\Model\Item[]**](Item.md) | [readonly] If the type is application.json then this will contain a JSON representation of the relevant model | [optional]
